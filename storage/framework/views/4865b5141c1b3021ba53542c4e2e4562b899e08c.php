<link rel="stylesheet" type="text/css" href="<?php echo e($site_url, false); ?>/css/nurse_sheet_approval.css">
<?php echo Form::hidden('monitor_data', json_encode($monitor_data)); ?>

<?php echo Form::hidden('ventilator_data', json_encode($ventilator_data)); ?>

<?php echo Form::hidden('pump_data', json_encode($pump_data)); ?>
                    ...
                    <div class="stepper">
                        ...
                        <form role="form" class="m-0">
                            <div class="tab-content">
                                <div id="modal-loader" class="loading-center" style="background: url('<?php echo e($site_url, false); ?>/img/icons/preloader.gif') center no-repeat #e8eef6"></div>
...
<?php echo $__env->make('nurse_sheet.nurse_sheet_approval_script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
