...
$(document).ready(function() {
    ...
    function approve() {
        ...
        if (emr_id.length > 0) {
            $.ajax({
                ...
                url: "<?php echo e(action('Nurse\NurseSheetController@machineDataApproval'), false); ?>",
    ...
    $(document).on('click', '#edit-update', function() {
        ...
        if (edit_val == '' && type_edit_val != 'radio') {
            ...
            $.ajax({
                ...
                url: "<?php echo e(action('Nurse\NurseSheetController@machineDataUpdate'), false); ?>",
                success: function(response) {
                    if (response.messageType == 'success') {
                        var id = response.id;
    ...
    function monitorData(trigger_modal_slug = false) {
        ...
        if (trigger_modal_slug) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(action('Nurse\NurseSheetController@getMonitorData'), false); ?>",
                success: function(response) {
                    monitor_data_processing(response);
                },
                complete: function() {
    ...
    function ventilatorData(trigger_modal_slug = false) {
        ...
        if (trigger_modal_slug) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(action('Nurse\NurseSheetController@getVentilatorData'), false); ?>",
                success: function(response) {
                    ventilator_data_processing(response)
                },
                complete: function() {
    ...
    function pumpData(trigger_modal_slug = false) {
        ...
        if (trigger_modal_slug) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(action('Nurse\NurseSheetController@getPumpData'), false); ?>",
                success: function(response) {
                    pump_data_processing(response)
                },
                complete: function() {
    ...
    function labData() {
        $.ajax({
            ...
            url: "<?php echo e(action('Nurse\NurseSheetController@getLabData'), false); ?>",
            beforeSend: function() {
                $(".temp-row").show();
            },
            success: function(response) {
