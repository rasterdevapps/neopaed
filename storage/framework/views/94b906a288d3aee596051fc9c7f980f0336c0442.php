<select class="form-control patient-filter input-width-small display-inline-block">
	...
	<option value="inpatient" <?php if(isset($_GET['status']) && $_GET['status'] == 'inpatient' || isset($status) && $status == 'inpatient'): ?> selected="selected" <?php endif; ?>>Inpatient</option>
	<option value="discharged" <?php if(isset($_GET['status']) && $_GET['status'] == 'discharged' || isset($status) && $status == 'discharged'): ?> selected="selected" <?php endif; ?>>Discharge</option>
	<option value="All" <?php if(isset($_GET['status']) && $_GET['status'] == 'All' || isset($status) && $status == 'All'): ?> selected="selected" <?php endif; ?>>All</option>
</select>
