<script class="special-print-css" type="text/javascript" src="<?php echo e(url('/'), false); ?>/public/plugins/amcharts/amcharts.js"></script>
<script class="special-print-css" type="text/javascript" src="<?php echo e(url('/'), false); ?>/public/plugins/amcharts/serial.js"></script>
<script class="special-print-css" type="text/javascript" src="<?php echo e(url('/'), false); ?>/public/plugins/amcharts/pie.js"></script>

<script type="text/javascript" src="<?php echo e(url('/'), false); ?>/js/amcharts5/index.js"></script>
<script type="text/javascript" src="<?php echo e(url('/'), false); ?>/js/amcharts5/xy.js"></script>
<script type="text/javascript" src="<?php echo e(url('/'), false); ?>/js/amcharts5/themes_animated.js"></script>
