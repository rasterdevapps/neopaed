...
<div class="crumbs bread-crumbs-shadow">
    <ul id="breadcrumbs" class="breadcrumb">
        <li>
            <i class="icon-home"></i>
            <a href="<?php echo e(url('/'), false); ?>"><?php echo e(Lang::get('home.nurse_hour_wise_dashboard'), false); ?></a>
        </li>
        <li class="current">
            <a href="<?php echo e(action('Nurse\NurseSheetController@index'), false); ?>"><?php echo e(Lang::get('home.nurse_hour_wise_nurse_sheet'), false); ?></a>
        </li>
    </ul>
</div>
<!-- /Breadcrumbs line -->
    ...
    <div class="col-md-12">
        <div class="widget box table-view-shadow">
            <div class="widget-header">
                ...
                <a href="<?php echo e(action('Nurse\NurseSheetController@create'), false); ?>" title="Create New" class="btn  create-btn-spacing btn-basic-shadow btn-info pull-right create-btn">
            ...
            <div class="widget-content">
                        ...
                        <div class="dataTables_header clearfix" >
                            <div class="col-xs-4 col-sm-6 col-md-6">
                                <div id="data-list_length" class="dataTables_length ">
                                    ...
                                    <?php echo Form::open(['url' => action('Nurse\NurseSheetController@index'), 'method' => 'get', 'id' => 'limit-form']); ?>
                            ...
                            <?php echo Form::open(['url' => action('Nurse\NurseSheetController@index'), 'method' => 'get', 'id' => 'search-form','class' => 'search_form']); ?> 
                            <div class="col-xs-8 col-sm-6 col-md-4 pull-right">
                                <div class="input-group">
                                    ...
                                    <a href="<?php echo e(action('Nurse\NurseSheetController@index'), false); ?>" class="input-group-addon"><i class="glyphicon glyphicon-remove"></i></a>
                                </div>
                            </div>
                            <?php echo Form::close(); ?>
                ...
                <table class="table table-striped table-bordered table-responsive"  id="data-list">
                    <thead>
                        <tr>
                            <th class="sorting_by sorting_icon <?php if($order['sortby'] == 'BabyName'): ?> sorting_<?php echo e($order['sortorder'], false); ?>_icon <?php endif; ?>" data-field="<?php echo e(SiteHelpers::encrypt_id('BabyName'), false); ?>">Baby Name</th>
                    ...
                    <tbody>
                        <?php $i = 1; ?>
                        <?php $closewinlink = 'nicu-nurse-sheets'; ?>
                        <?php if(count($results) > 0): ?>
                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $results_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                        <?php if(trim($results_value->BabyName) != '' && trim($results_value->BMrNo) != ''): ?>
                        <tr>
                            <td class="text-left">
                                <a href="<?php echo e(url('nicu-nurse-sheet-day/'.SiteHelpers::encrypt_id($results_value->BabyId).'/'.$closewinlink), false); ?>?list=true" class="text-captialize">
                                <?php echo e($results_value->BabyName, false); ?>

                                </a>
                            </td>
                            <td><?php echo e($results_value->BMrNo, false); ?></td>
                            <td><?php echo e(is_null($results_value->DOB) ? '' : date('d-m-Y',strtotime($results_value->DOB)), false); ?></td>
                        </tr>
                        <?php endif; ?> 
                        <?php $i++; ?>
                                ...
                                <div class="dataTables_paginate paging_bootstrap pagination_footer">
                                    <ul class="pagination">
                                        <li class="prev <?php if(Request::query('page') == '' || Request::query('page') == $pagination['start']): ?> disabled <?php endif; ?>">
                                            <a class="<?php if(Request::query('page') != $pagination['start'] &&  Request::query('page') != ''): ?> sort_with_page <?php endif; ?>" href="<?php if(Request::query('page') == $pagination['start'] || Request::query('page') == ''): ?> javascript:void(0); <?php else: ?> <?php echo e(url('nicu-nurse-sheets?page='.$pagination['previous']), false); ?><?php endif; ?>">&#8592; Previous</a>
                                        </li>
                                        ...
                                        <li class="<?php if($i == Request::query('page')): ?> active <?php elseif(Request::query('page') == '' && $i == $pagination['start']): ?> active <?php endif; ?>">
                                            <a class='sort_with_page' href="<?php echo e(url('nicu-nurse-sheets?page='.$i), false); ?>"><?php echo e($i, false); ?></a>
                                        </li>
                                        <?php endfor; ?>
                                        <li class="next <?php if(Request::query('page') == $pagination['end'] || $pagination['total'] <= $pagination['limits']): ?> disabled <?php endif; ?>">
                                            <a class="<?php if(Request::query('page') != $pagination['end'] && $pagination['start'] != $pagination['end']): ?> sort_with_page <?php endif; ?>" href="<?php if(Request::query('page') == $pagination['end'] || $pagination['total'] <= $pagination['limits']): ?> javascript:void(0); <?php else: ?> <?php echo e(url('nicu-nurse-sheets?page='.$pagination['next']), false); ?><?php endif; ?>">Next &#8594; </a>  
                                        </li>
                                    </ul>
                                </div>
                            </div>
