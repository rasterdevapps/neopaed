    ...
    <div class="temp-row mb-0">
        <div class="col-md-12 plr-must-0">
            <div class="col-md-4 col-sm-4 col-xs-12 plr-must-0">
                <img src="<?php echo e(ValuelistHelpers::printPagelogo(), false); ?>">
            </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-4 plr-must-0 barcode text-center">
                <?php if(!empty($ip_details->ip_number) && !is_null($ip_details->ip_number)): ?>
                <table>
                    <tr>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 basic-detail plr-must-0">
            ...
            <div class="content-block">
                <table class="table-layout-fixed">
                    <tbody>
                        <tr>
                            <td><strong>Name:</strong> <span class="font-normal"><?php echo e($baby->BabyName, false); ?></span></td>
                            <td><strong><?php echo e(Lang::get('home.mrn'), false); ?>:</strong> <span class="font-normal"><?php echo e($baby->BMrNo, false); ?></span></td>
                            <td><strong><?php echo e(Lang::get('home.ip'), false); ?>:</strong> <span class="font-normal"><?php echo e((!empty($ip_details->ip_number) && !is_null($ip_details->ip_number)) ? $ip_details->ip_number : null, false); ?></span></td>
                        </tr>
                        <tr>
                            <td><strong>DOB:</strong> <span class="font-normal"><?php echo e(empty($baby->DOB) ? '' : date('d-m-Y', strtotime($baby->DOB)), false); ?></span></td>
                            <td><strong>Sex:</strong> <span class="font-normal"><?php echo e($baby->Sex, false); ?></span></td>
                        </tr>
                        <tr>
                            <td colspan="5"><strong>Consultant:</strong> <span class="font-normal"><?php echo e(\SiteHelpers::get_doctors_name($baby->neonatal_consultant), false); ?></span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="sort-btn-lab">
                ...
                <input id="sort_order" data-on="Desc" data-off="Asc" data-toggle="toggle" data-width="70" data-size="small" class="form-control" type="checkbox" <?php if(isset($order) && $order == 'desc'): ?> checked <?php endif; ?>>
            </div>
        </div>
        <div role="tabpanel" class="tabbable tabbable-custom">
            <ul class="nav nav-tabs hidden-print" role="tablist">
                ...
                <li role="presentation">
                    ...
                    <span <?php if($pending_results_count > 0): ?> class="request-count" <?php endif; ?>><?php if($pending_results_count > 0): ?> <?php echo e($pending_results_count, false); ?> <?php endif; ?></span>
                </li>
                <li role="presentation">
            ...
            <div class="tab-content">
                        ...
                        <table class="table hour-wise-table fixed" id="lab-report-table">
                            <thead>
                                <tr>
                                    ...
                                    <?php $j = 0;$k = 1; ?>
                                    <?php $__currentLoopData = $first_tab_sheet_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $day_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                    <th class="<?php echo e(str_slug(date('d-m-YHi', strtotime($day_id))), false); ?>"><?php echo e(date('d-m-Y', strtotime($day_id)), false); ?> <br><small>(<?php echo e(date('H:i', strtotime($day_id)), false); ?>)</small> <?php if($tooltip_text != '' ): ?><i class="material-name fa fa-info-circle bs-tooltip color-black-must hidden-print" data-toggle="tooltip" data-placement="right" data-html="true" data-title="<?php echo e($tooltip_text, false); ?>"></i><?php endif; ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php echo $sodium_display_content; ?>         
                                </tr>
                                <tr>
                                    <td>Potassium <span class="print-small">(3.2-5 mmol/L)</span></td>
                                    <?php echo $potassium_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Chloride <span class="print-small">(96-106 mmol/L)</span></td>
                                    <?php echo $chloride_display_content; ?>           
                                </tr>
                                <tr>
                                    <td>Bicarbonate <span class="print-small">(22-26 mmol/L)</span></td>
                                    <?php echo $bicarbonate_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Calcium <span class="print-small">(8.5-10.5 mg/dl)</span></td>
                                    <?php echo $calcium_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Magnesium <span class="print-small">(0.6-1.1 nmol/L)</span></td>
                                    <?php echo $magnesium_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Phosphorus <span class="print-small">(2.7-4.5 mg/dl)</span></td>
                                    <?php echo $phosphorus_display_content; ?>

                                </tr>
                                <tr>
                                    <td>BUN (urea) <span class="print-small">(6-20 mg/dl)</span></td>
                                    <?php echo $bun_urea_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Creatintine <span class="print-small">(0.6-1.4 mg/dl)</span></td>
                                    <?php echo $creatintine_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Glucose <span class="print-small">(70-110 mg/dl)</span></td>
                                    <?php echo $glucose_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Creatine Kinase (CK) <span class="print-small">(26-174 U/L)</span></td>
                                    <?php echo $creatine_kinase_display_content; ?>

                                </tr>
                                <tr>
                                    <td>CK - MB <span class="print-small">(<\6% of Total CK)</span></td>
                                        <?php echo $ck_mb_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Trop. T</td>
                                        <?php echo $trop_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Total bilirubin <span class="print-small">(< 1 mg/dl)</span></td>
                                        <?php echo $total_bilirubin_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Direct bilirubin <span class="print-small">(< 0.4 mg/dl)</span></td>
                                        <?php echo $direct_bilirubin_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>SGOT (AST) <span class="print-small">(< 0-40 U/L)</span></td>
                                        <?php echo $sgot_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>SGPT (AST) <span class="print-small">(< 0-40 U/L)</span></td>
                                        <?php echo $sgpt_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Alkaline Phosphatase <span class="print-small">(30-115 U/L)</span></td>
                                        <?php echo $alkaline_phosphatase_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Gama GTP <span class="print-small">(F5-55, M15-85 U/L)</span></td>
                                        <?php echo $gama_gtp_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>LDH <span class="print-small">(90-220 U/L)</span></td>
                                        <?php echo $ldh_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Amylase <span class="print-small">(31-123 U/L)</span></td>
                                        <?php echo $amylase_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Lipase</td>
                                        <?php echo $lipase_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Total Protein <span class="print-small">(6-8.4 gm/dl)</span></td>
                                        <?php echo $total_protein_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Albumin <span class="print-small">(3.5-5.3 gm/dl)</span></td>
                                        <?php echo $albumin_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Total Cholesterol</td>
                                        <?php echo $total_cholesterol_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>HDL</td>
                                        <?php echo $hdl_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>LDL</td>
                                        <?php echo $ldl_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>VLDL</td>
                                        <?php echo $vldl_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>Tri Glycerides</td>
                                        <?php echo $tri_glycerides_display_content; ?>

                                    </tr>
                                    <tr>
                                        <td>TSH</td>
                                        <?php echo $tsh_display_content; ?>

                                    </tr>
                                    <?php $colcount = 2 ?>
                                    <?php $__currentLoopData = $sheet_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $date = date('d-m-Y', strtotime($day_id)); ?>
                                    <?php if(isset($result[$date])): ?>
                                    <?php $temp_data = $result[$date]; ?>
                                    <?php $colcount = $colcount + count($temp_data); ?>
                                    <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <!--  <tr>
                                    <td colspan="<?php echo e($colcount, false); ?>" style="padding: 10px !important;"></td>
                                </tr> -->
                                <tr>
                                ...
                                <tr>
                                    <td>Blood Group</td>
                                    <?php echo $blood_group_display_content; ?>

                                </tr>
                                <tr>
                                    <td>RBC <span class="print-small">(3.5-5.5 106/ul)</span></td>
                                    <?php echo $rbc_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Haemoglobin <span class="print-small">(11-17 gm%)</span></td>
                                    <?php echo $haemoglobin_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Haematocrit (PCV) <span class="print-small">(35-55)</span></td>
                                    <?php echo $haematocrit_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Reticulocyte count <span class="print-small">(0.5-1.5 %)</span></td>
                                    <?php echo $reticulocyte_count_display_content; ?>

                                </tr>
                                <tr>
                                    <td>WBC : Total <span class="print-small">(4.000-11.0000/ul)</span></td>
                                    <?php echo $wbc_total_count_display_content; ?>

                                </tr>
                                <tr>
                                    <td>DC : Poly <span class="print-small">(40-75 %)</span></td>
                                    <?php echo $dc_poly_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Lymph <span class="print-small">(0-75 %)</span></td>
                                    <?php echo $lymph_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Mono <span class="print-small">(2-10 %)</span></td>
                                    <?php echo $mono_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Eos <span class="print-small">(1-6 %)</span></td>
                                    <?php echo $eos_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Baso <span class="print-small">(0-1 %)</span></td>
                                    <?php echo $baso_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Platelets <span class="print-small">(1,50,000-4,50,000)</span></td>
                                    <?php echo $platelets_display_content; ?>

                                </tr>
                                <tr>
                                    <td>ESR <span class="print-small">(M: 3-10; F: 5-20)</span></td>
                                    <?php echo $esr_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Prothrombin Time</td>
                                    <?php echo $prothrombin_time_display_content; ?>

                                </tr>
                                <tr>
                                    <td>APTT</td>
                                    <?php echo $aptt_display_content; ?>

                                </tr>
                                <tr>
                                    <td>INR</td>
                                    <?php echo $inr_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Fibrinogen</td>
                                    <?php echo $fibrinogen_display_content; ?>

                                </tr>
                                <tr>
                                    <td>FDP</td>
                                    <?php echo $fdp_display_content; ?>

                                </tr>
                                <tr>
                                    <td>CRP</td>
                                    <?php echo $crp_display_content; ?>

                                </tr>
                                <tr>
                                    <td>FT4</td>
                                    <?php echo $ft4_display_content; ?>

                                </tr>
                                <tr>
                                    <td>FT3</td>
                                    <?php echo $ft3_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Ammonia</td>
                                    <?php echo $ammonia_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Lactate</td>
                                    <?php echo $lactate_display_content; ?>

                                </tr>
                                <tr>
                                    <td>DCT</td>
                                    <?php echo $dct_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Procalcitonin</td>
                                    <?php echo $procalcitonin_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Vitamin D3</td>
                                    <?php echo $vitamin_d3_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Parathormone</td>
                                    <?php echo $parathormone_display_content; ?>
                        ...
                        <table class="table hour-wise-table fixed" id="urine-report-table">
                            <thead>
                                <tr>
                                    <th colspan="2" class="text-center">Field Name</th>
                                    <?php $j = 0;$k = 1; ?>
                                    <?php $__currentLoopData = $second_tab_sheet_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    $date = date('d-m-Y H:i', strtotime($day_id));
                                    ?>
                                    <th class="<?php echo e(str_slug(date('d-m-YHi', strtotime($day_id))), false); ?>"><?php echo e(date('d-m-Y', strtotime($day_id)), false); ?> <br><small>(<?php echo e(date('H:i', strtotime($day_id)), false); ?>)</small></th>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>     
                                </tr>
                            </thead>
                            <tbody style="vertical-align: middle;">
                                ...
                                <tr>
                                    <td>Color</td>
                                    <?php echo $second_tab_empty_content; ?>

                                </tr>
                                <tr>
                                    <td>Specific Gravity</td>
                                    <?php echo $urine_specific_gravity_display_content; ?>

                                </tr>
                                <tr>
                                    <td>pH</td>
                                    <?php echo $urine_ph_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Protein</td>
                                    <?php echo $urine_protein_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Glucose</td>
                                    <?php echo $urine_glucose_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Bilirubin</td>
                                    <?php echo $urine_bilirubin_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Urobilinogen</td>
                                    <?php echo $urine_urobilinogen_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Ketones</td>
                                    <?php echo $urine_ketones_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Nitrate</td>
                                    <?php echo $urine_nitrate_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Pus Cells</td>
                                    <?php echo $urine_pus_cells_display_content; ?>

                                </tr>
                                <tr>
                                    <td>RBC<sub>s</sub></td>
                                    <?php echo $urine_rbc_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Epithelial Cells</td>
                                    <?php echo $urine_epithelial_cells_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Crystals</td>
                                    <?php echo $urine_crystals_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Casts</td>
                                    <?php echo $urine_casts_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Osmolality</td>
                                    <?php echo $urine_osmolality_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Bile Salts</td>
                                    <?php echo $urine_bile_salts_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Bile Pigments</td>
                                    <?php echo $urine_bile_pigments_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Blood</td>
                                    <?php echo $urine_blood_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Heamoglobin</td>
                                    <?php echo $urine_heamoglobin_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Spot Sodium</td>
                                    <?php echo $urine_spot_sodium_display_content; ?>

                                </tr>
                                <tr>
                                    <td>FE Na</td>
                                    <?php echo $urine_fena_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Spot Potassium</td>
                                    <?php echo $urine_spot_potassium_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Spot Chloride</td>
                                    <?php echo $urine_spot_chloride_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Spot Creatinine</td>
                                    <?php echo $urine_spot_creatinine_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Creatinine Clearance</td>
                                    <?php echo $urine_creatinine_clearance_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Leukocytes Esterases</td>
                                    <?php echo $urnine_leukocytes_esterases_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Others</td>
                                    <?php echo $urine_others_display_content; ?>
                                ...
                                <tr>
                                    ...
                                    <?php echo $csf_proteins_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Glucose (CSF 50-75 mg/dl)</td>
                                    <?php echo $csf_glucose_display_content; ?>
                                ...
                                <tr>
                                    <td>Cell Count</td>
                                    <?php echo $csf_cell_count_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Neutrophils (%)</td>
                                    <?php echo $csf_neutrophils_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Lymphocytes (%)</td>
                                    <?php echo $csf_lymphocytes_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Eosinophils (%)</td>
                                    <?php echo $csf_eosinophils_display_content; ?>

                                </tr>
                                <tr>
                                    <td>RBC</td>
                                    <?php echo $csf_rbc_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Gram Stain</td>
                                    <?php echo $csf_gram_stain_display_content; ?>
                                ...
                                <tr>
                                    <td>WBC</td>
                                    <?php echo $stool_wbc_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Occult Blood</td>
                                    <?php echo $stool_occult_blood_display_content; ?>

                                </tr>
                                <tr>
                                    <td>Ova & Parasites</td>
                                    <?php echo $stool_ova_parasites_display_content; ?>
                ...
                <?php echo $__env->make('nurse_sheet.microbiology_report', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <div role="tabpanel" class="tab-pane hidden-print" id="pending-requests">
                    <?php if(count($pending_results_count) > 0): ?>
                    <ul class="pending-request-list">
                        <?php $__currentLoopData = $pending_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $req_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h4 style="display: inline-block; float: left">Number - <strong><?php echo e($key, false); ?></strong></h4>
                        <h4 style="display: inline-block; float: right">Date - <strong><?php echo e(date('d-m-Y H:i' ,strtotime($req_val[0]->createTime)), false); ?></strong></h4>
                        <div class="clearfix"></div>
                        <?php $__currentLoopData = $req_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $req_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($req_val->name, false); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <?php endif; ?>
                ...
                <div role="tabpanel" class="tab-pane" id="abg">
                    ...
                    <?php $__currentLoopData = $abg_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <table class="table hour-wise-table fixed" id="abg-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php echo $blood_sugar; ?>

                            </tr>
                            <tr>
                                <td>Blood Sugar (mg/dl)(Glucometer)</td>
                                <?php echo $blood_sugar_gm; ?>

                            </tr>
                            <tr>
                                <td>Methemoglobin</td>
                                <?php echo $methemoglobin; ?>
