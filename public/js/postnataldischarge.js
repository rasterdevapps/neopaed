...
$(document).on('click', '.post-report-editing:not(.not-available)', function(e) {
    $('.savebtn').addClass('hide');
    $('.new-preport-editing, .post-report-editing').addClass('not-available');
...
function updateProblemReport() {
    setStatus();
    $('.new-preport-editing, .post-report-editing').removeClass('not-available');
    $.ajax({
        headers: {
