        ...
        return $(this).each(function() {
            ...
            var _td_init = function(value) {
                ...
                _td_c.find('.td-lancette div:first').css('transform', 'rotate(' + Math.round((m * 360 / 59)) + 'deg)');
                 ...
                 if(_td_options.initialValue === true &&  (_td_options.setCurrentTime === true || _td_options.setCurrentTime === false)) {

                    _td_initial_time(_td_event_deg);

                 } else if(_td_options.initialValue === false && _td_options.setCurrentTime === false) {
