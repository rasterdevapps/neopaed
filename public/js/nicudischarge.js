...
var list = ["Birth", "Problems", "RespiratorySystem", "CardiovascularSystem", "GastrointestinalSystem", "Communicationwithparents", "Investigations", "DischargeInstructions", "CentralNervousSystem", "Sepsis", "Ophthalmology", "Hematology", "NewbornScreening", "Followup", 'DischargeMedications', 'Procedures', 'Summarybirth', 'vaccine'];
...
$.each(editor_content_name, function(key, value) {
    $(document).on('click', '.' + value + ':not(.not-available)', function(e) {
        $('.savebtn').addClass('hide');
        $('.new-report-editing, .checkingtest i.fa-pencil').addClass('not-available');
...
function updateDaycareReport() {
    setStatus();
    $('.new-report-editing, .checkingtest i.fa-pencil').removeClass('not-available');
    $.ajax({
        headers: {
...
$(document).on('click', '.new-report-editing:not(.not-available)', function(e) {
    e.preventDefault();
    $('.savebtn').addClass('hide');
    $('.new-report-editing, .checkingtest i.fa-pencil').addClass('not-available');
    $(this).removeClass('not-available');
...
$(document).on('click', '.checkingtest i.fa-pencil', function() {
    $('.savebtn').addClass('hide');
    $('.new-report-editing, .checkingtest i.fa-pencil').addClass('not-available');
    $(this).removeClass('not-available');
});
