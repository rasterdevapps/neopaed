...
class CreateProblemdaycaresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_problemdaycare', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('master_problemdaycare');
    }
}
