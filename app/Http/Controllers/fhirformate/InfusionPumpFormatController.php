...
class InfusionPumpFormatController extends Controller
{
     ...
     *@var $machine_data 
     */
	  public $machine_name = '2-pump-type-VP5';
    ...
    /**
     * This method to get infusion and syringe list
     * 
     * @param $babyid type integer
     * @param $admissionid type integer
     *
     */
    public function infusionSyringelist($babyid, $admissionid, Request $request)
    { 
        ...
        $infusionDetail         = FhirFormatedValues::infusionData($babyid, $admissionid, $request->input('page'), $limit, $search_txt, $order);
        $infusionDetails        = $infusionDetail['result'];

        $getTotal   = $infusionDetail['getTotal'];   
        $total      = $infusionDetail['total'];
        ...
        return view('ward.infusion-list', compact('infusionDetails', 'baby_details', 'admissionid', 'pagination' ,'search_txt', 'getTotal', 'order', 'navigate'));
