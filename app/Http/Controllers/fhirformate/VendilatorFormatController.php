...
class VendilatorFormatController extends Controller
{
     ...
     *
     */
     public function VendilatorList($babyid, $admissionid, Request $request)
     {
        ...
        $vendilator_detail     = FhirFormatedValues::vendilatorData($babyid, $admissionid, $request->input('page'), $limit, $search_txt, $order);
        $vendilator_details    = $vendilator_detail['result'];

        $getTotal   = $vendilator_detail['getTotal'];   
        $total      = $vendilator_detail['total'];
        ...
        return view('ward.vendilator-list', compact('vendilator_details', 'baby_details', 'babyid', 'admissionid', 'pagination' ,'search_txt', 'getTotal', 'order', 'navigate'));
