...
use App\Models\Masters\ResuscitationDrugs;
use Illuminate\Contracts\Auth\Guard;


class ResuscitationDrugsController extends Controller
{
	public function __construct(Guard $auth)
	{
		$this->middleware('role:MAS_RESUSCIATATION,write', ['only'=>['store','update','edit','create','destroy']]);
		$this->middleware('role:MAS_RESUSCIATATION,read', ['only'=>['index']]);	
		$this->auth = $auth;
	}
