...
use App\Http\Controllers\fhirformate\VendilatorFormatController;
use App\Http\Controllers\Fhir\ImportFhirController;

class VendilatorFormater extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'run:vendilatorformater';
    ...
    {
        $this->fhir_formate  = new VendilatorFormatController();
