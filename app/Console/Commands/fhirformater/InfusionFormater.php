...
use App\Http\Controllers\fhirformate\InfusionPumpFormatController;
use App\Http\Controllers\Fhir\ImportFhirController;

class InfusionFormater extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'run:infusionformater';
    ...
    {
        $this->fhir_formate  = new InfusionPumpFormatController();
