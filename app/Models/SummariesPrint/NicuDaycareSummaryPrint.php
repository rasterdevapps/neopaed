...
class NicuDaycareSummaryPrint extends Model
{
    protected $table = 'nicu_daycare_summary_print';
    ...
    {
    	$results = self::select('nicu_daycare_summary_print.id', 'printed_date_time', 'name', 'approved_user_ids')
