...
class PostnatalSummaryPrint extends Model
{
    protected $table = 'postnatal_summary_print';
    ...
    {
    	$results = self::select('postnatal_summary_print.id', 'printed_date_time', 'name', 'approved_user_ids')
