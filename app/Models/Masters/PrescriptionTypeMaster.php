...
class PrescriptionTypeMaster extends Model
{
   /**
    ...
    *@var $table
	*/
	protected $table = 'mas_prescription_type';
	...
	*/
	...
	public static function  list($page = 1, $limit = 50, $condition, $order = array(), $slug = '')
	{
		...
		$results    = DB::table('mas_prescription_type')
		->select('*')
		->where('is_deleted', 0)
	...
	public static function getPrescriptionType() 
	{
		$results = DB::table('mas_prescription_type')
		->where('is_deleted', 0)
    	->where('status', 1)
