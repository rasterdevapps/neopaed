...
class ProblemMaster extends Model 
{
	...
	protected $table = 'mas_problems';
	protected $primaryKey = 'Id';
	public $timestamps  =  false;
	protected $fillable = ['Name','Status','UserAdded','UserModified','DateAdded','DateModified','UserDeleted','IsDeleted'	];
	/**
		FETCH RECORDS TO DISPLAY IN THE MASTERS LISTING AND IN OTHER MODULES.
	*/
	public static function  ListData()
	{
		$results = DB::table('mas_problems')
	 ...
	 *
	 * @return problems count in integer
	 */
