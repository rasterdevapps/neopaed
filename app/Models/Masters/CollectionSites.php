...
class CollectionSites extends Model
{
    protected $table = 'mas_collection_site';
	...
	{
		$results = \DB::table('mas_collection_site')
     ...
     * @return collection site list in array of object 
     */
