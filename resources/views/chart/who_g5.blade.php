...
<div class="temp-container">
    <div class="temp-row mt-15">
        ...
        <div class="col-md-11">
            <h3 class="print-head">
               WHO Growth Chart - 5 to 19 Years
           </h3>
       </div> 
       <div class="col-md-12" style="margin-bottom: 30px;">
        ...
        <input type="hidden" name="bmi_provider" value="{{ json_encode($bmi_provider) }}">
        ...
        <input type="hidden" name="bmi_value_count" value="{{ json_encode($bmi_value_count) }}">
        ...
        <div id="wt-container" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div id="wt-header-container" class="theme-{{strtolower($baby->Sex)}} ">
                <div class="pull-left">
                    ...
                    <span class="left-spacing text-left chart-title-1">5 to 10 years (percentiles)</span>
                </div>
            ...
            <div id="wt-chart-text">
                <span class="pull-right pt-5">2007 WHO Reference</span>
            </div>
        </div>
        <div id="ht-container" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div id="ht-header-container" class="theme-{{strtolower($baby->Sex)}} ">
                <div class="pull-left">
                    <span class="chart-title left-spacing">Height-for-age {{$theme_name}}</span>
                    <span class="underline"></span>
                    <span class="left-spacing text-left chart-title-1">5 to 19 years (percentiles)</span>
                </div>
                <div class="pull-right mt-15">
                    <img src="{{$site_url}}/img/who-logo.png">
                </div>
        ...
        <div id="bmi-container" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div id="bmi-header-container" class="theme-{{strtolower($baby->Sex)}} ">
                <div class="pull-left">
                    <span class="chart-title left-spacing">BMI-for-age {{$theme_name}}</span>
                    <span class="underline"></span>
                    <span class="left-spacing text-left chart-title-1">5 to 19 years (percentiles)</span>
                </div>
                <div class="pull-right mt-15">
            ...
            <div id="bmi-chart-container" class="pull-left full-width"></div>
            <div id="bmi-chart-text">
                <span class="pull-right pt-5">2007 WHO Reference</span>
            </div>
        </div>
    </div>
