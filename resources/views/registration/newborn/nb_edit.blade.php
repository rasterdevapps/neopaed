		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
                       {!! Form::model($results,['method'=> 'PATCH','url' => 'newborn/'.$results->NewBornId]) !!}
  <!-- Nav tabs -->
                <div role="tabpanel">
 ...
 <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="basicform">
						<div class="col-md-5 ">
                       		...
                       		<div class="form-group">
                            	{!! Form::label('BabyName','Select Baby:') !!}
                                {!! Form::text('BabyName',null,['readonly','class'=>'form-control']) !!}
                            </div>
...
<div role="tabpanel" class="tab-pane" id="vitals">
                       ...
                       <div class="col-md-offset-1 col-md-5">                             
                      		<div class="form-group">
                                ...
                                {!! Form::select('CentralPulses',['Well Palpable'=>'Well Palpable','Bounding'=>'Bounding','feeble'=>'feeble'],null,['class'=>'form-control']) !!}
                            </div>
                       		<div class="form-group">
    ...
    <div role="tabpanel" class="tab-pane" id="cvs">
                         ...
                         <div class=" col-md-5">
                       		...
                       		<div class="form-group">
                                ...
                                {!! Form::select('PrecordialActivity',[''=>'Select','Present'=>'Present','Absent'=>'Absent'],null,['class'=>'form-control']) !!}                                </div>                                                        
                       		                                                       
                       		<div class="form-group">
                            	{!! Form::label('ApicalImpulse','Apical Impulse:') !!}
                                {!! Form::select('ApicalImpulse',[''=>'Select','Normal'=>'Normal','Right Side'=>'Right Side'],null,['class'=>'form-control']) !!}
                            </div>               

                       		<div class="form-group">
                            	{!! Form::label('BoundingPulses','Bounding Pulses:') !!}
                                 {!! Form::select('BoundingPulses',[''=>'Select','Present'=>'Present','Absent'=>'Absent'],null,['class'=>'form-control']) !!} 
                            </div>                            
                         ...
                         <div class="col-md-offset-1 col-md-5">
                      		<div class="form-group">
                                ...
                                {!! Form::select('S1S2',[''=>'Select','Normal'=>'Normal','Abnormal'=>'Abnormal'],null,['class'=>'form-control']) !!}
                            </div>                                           
                       		<div class="form-group">
                            	{!! Form::label('Murmur','Murmur:') !!}
                                 {!! Form::select('Murmur',[''=>'Select','Present'=>'Present','Absent'=>'Absent'],null,['class'=>'form-control']) !!} 
                            </div>
                       		<div class="form-group">
...
<div role="tabpanel" class="tab-pane" id="rs">
                         ...
                         <div class=" col-md-5">
                       		...
                       		<div class="form-group">
                                ...
                                {!! Form::select('ChestMovement',[''=>'Select','Symmetrical'=>'Symmetrical','Asymmetrical'=>'Asymmetrical'],null,['class'=>'form-control']) !!}
                                </div>                                                        
                       		                                                       
                       		<div class="form-group">
                            	{!! Form::label('BreathSounds','Breath Sounds:') !!}
                                {!! Form::select('BreathSounds',[''=>'Select','Normal Vesicular'=>'Normal Vesicular','Abnormal'=>'Abnormal'],null,['class'=>'form-control']) !!}
                            </div>               
                            ...
                            <div class="col-md-offset-1 col-md-5">                  
                       		<div class="form-group">
                                ...
                                {!! Form::select('AddedSounds',[''=>'Select','Present'=>'Present','Absent'=>'Absent'],null,['class'=>'form-control']) !!}
                            </div>                                           
                       		<div class="form-group">
