...
<div class="crumbs bread-crumbs-shadow">
    <ul id="breadcrumbs" class="breadcrumb">
        ...
        <li>
            ...
            @else
            <a title="" href="{{ action('Registration\NeonatalController@neonatalDichargelist') }}">Neonatal Discharge Details</a>
            @endif
        </li>
        <li class="current">
            <a href="javascript:void(0);" title="">Edit @if(isset($results->BabyName) && !empty($results->BabyName)) For {{ $results->BabyName }} @endif @if(isset($results->BMrNo) && !empty($results->BMrNo))   {{ $results->BMrNo }}  @endif</a>
        </li>
    </ul>
...
<div class="row row-spacing">
    <div class="col-md-12 neonatal-edit">
        {!! Form::model($results,['method'=> 'PATCH','url' => action('Registration\NeonatalController@update',$results->NeonatalId),'id' => 'neonatalPerforma-form', 'class' => 'm-0']) !!}
        @include('errors.list')
        <!-- Nav tabs -->
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('TestDate',null,['class'=>'form-control baby-dob', 'readonly' => 'true']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        <div class="display-flex">
                                            ...
                                            @if (str_contains(strtolower($results->BabyName), $default_name))
                                                {!! Form::hidden('BMrNo', null,['id'=>'BMrNo']) !!}
                                                {!! Form::hidden('old_baby_name', $results->BabyName) !!}
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                        {!! Form::label('BirthStatus','Birth Status:', ['class'=>'required-label']) !!}
                                    </div>
                                    <div class="col-md-9 custom-input">
                        ...
                        <div class="widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('BirthOrder',[''=>'N/A']+ValuelistHelpers::mptypeNobabies(@$results->MultiplePregnancyType),null,['class'=>'form-control', 'readonly']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        ...
                                        @endif
                                        @else
                                        {!! Form::select('transfer_status',ValuelistHelpers::getTransferstatus(),$results->transfer_status,['class'=>'form-control', 'id'=>'transfer_status']) !!}
                                        @endif
                                        @else
                                        {!! Form::select('',ValuelistHelpers::getTransferstatus(),'NICU',['class'=>'form-control', 'readonly']) !!}
                                        @endif
                                    </div>
                                </div>
                                {{--      
                                <div class="form-group row nicu_bed_reg">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        ...
                                        {{ Form::text('room_id', $bed_logs->room_id, ['class'=>'form-control room-name', 'id'=>'room_id', 'readonly']) }}
                                        @else
                                        {{ Form::text('room_id', null, ['class'=>'form-control room-name', 'id'=>'room_id', 'readonly']) }}
                                        @endif
                                        <!--  <select class="form-control room-name" id="room_id" name="room_id">
                                            @if(isset($room_list) && !empty($room_list))
                                                @foreach($room_list as $room_key => $room_val)
                                                    @if(isset($bed_logs->bed_no) && $room_val == $bed_logs->room_no)
                                                        <option value="{{ $room_key }}" selected="selected">{{ $room_val }}</option>
                                                    @else
                                ...
                                <div class="form-group row nicu_bed_reg">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        @if(isset($bed_logs->bed_no) && !empty($bed_logs->bed_no))
                                        ...
                                        <!-- <select class="form-control bed-name" id="bed_id" name="bed_id">
                                            @if(isset($bed_list) && !empty($bed_list))
                                                @foreach($bed_list as $bed_key => $bed_val)
                                                    @if(isset($bed_logs->bed_no) && $bed_val == $bed_logs->bed_no)
                                                        <option value="{{ $bed_key }}" selected="selected">{{ $bed_val }}</option>
                                                    @else
                                                        <option value="{{ $bed_key }}">{{ $bed_val }}</option>
                                                    @endif
                                                @endforeach
                                            @else
                                    ...
                                    <div class="col-md-12 custom-input">
                                        <table class="medi table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{!! Form::select('Problems['.$pdm_key.']',$probs,$data['Problem'],["class"=>'form-control input-width-xlarge']) !!}</td>
                                                    <td><input type="text" name="Medications[{{ $pdm_key }}]" value="{!! $data['Medication']; !!}" class="form-control input-width-xlarge" /></td>
                                    ...
                                    <div class="col-md-12 custom-input">
                                        <table class="delivery table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($delivery_details as $com_key => $com_data)
                                                <tr>
                                                    <td><input type="text" class="form-control input-width-mini" id="OH_YEAR" name="Year[{{ $com_key }}]" value="{!! $com_data['Year']; !!}" /></td>
                                                    <td><input type="text" class="form-control" name="Place[{{ $com_key }}]" value="{!! $com_data['Place']; !!}" /></td>
                                                    <td class="input-width-medium">{!! Form::select('Delivery['.$com_key.']',[''=>'N/A','Vaginal'=>'Vaginal','LSCS'=>'LSCS','Instrumental'=>'Instrumental','Breech'=>'Breech'], $com_data['Delivery'], ['class'=>'form-control']) !!}</td>
                                                    <td><input type="text" class="form-control" name="Complications[{{ $com_key }}]" value="{!! $com_data['Complications']; !!}" /></td>
                                                    <td class="input-width-medium">{!! Form::select('Gender['.$com_key.']',[''=>'N/A','Male'=>'Male','Female'=>'Female','Indeterminate'=>'Indeterminate'], $com_data['Gender'], ['class'=>'form-control']) !!}</td>
                                                    <td><input type="text" class="form-control input-width-mini" name="GA[{{ $com_key }}]" value="{!! $com_data['GA']; !!}" /></td>
                                                    <td><input type="text" class="form-control input-width-mini" name="BW[{{ $com_key }}]" value="{!! $com_data['BW']; !!}" /></td>
                                                    <td class="input-width-medium">{!! Form::select('Health['.$com_key.']',[''=>'N/A','Alive'=>'Alive','Died'=>'Died','Unhealthy'=>'Unhealthy'], $com_data['Health'], ['class'=>'form-control']) !!}</td>
                        ...
                        <div class="widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('AdjustedRiskForTrisomy21',null,['class'=>'form-control', 'readonly' => 'true']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('AdjustedRiskForTrisomy18',null,['class'=>'form-control', 'readonly' => 'true']) !!}
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 custom-input">
                                        <table class="complication table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                @if (!$complication->isEmpty() && isset($complication) && count($complication) > 0)
                                                @php $l = 0; @endphp
                                                @foreach ($complication as $key => $com_data)
                                                @php $com_data['duration_in_weeks'] = isset($com_data['duration_in_weeks']) ? $com_data['duration_in_weeks'] : '';  @endphp
                                                <tr>
                                                    <td class="form-group">{!! Form::select('Complication['.$key.']',ValuelistHelpers::getMastercomplications(),$com_data['Complication'],["class"=>"complication-disabled complication-search","id"=>"complication-search-".$l, "style"=>"width: 257px;"]) !!}</td>
                                                    <td class="form-group"> {!!Form::text('Treatments['.$key.']',$com_data['Treatment'],['class'=>'form-control input-width-large complication-disabled']) !!}</td>
                                                    <td class="form-group"> {!!Form::text('duration_in_weeks['.$key.']',$com_data['duration_in_weeks'],['class'=>'form-control input-width-medium complication-disabled','id' => 'duration_in_weeks']) !!}</td>
                                                    <td class="form-group"> {!!Form::select('duration_unit['.$key.']',ValuelistHelpers::getdurationUnit(),$com_data['duration_unit'],['class'=>'form-control input-width-medium complication-disabled']) !!}</td>
                                ...
                                <div class="col-md-7 plr-0 form-group row">
                                    <div class="col-md-12 custom-input">
                                        <table class="usg table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="form-group"><input type="text" value="{{ (isset($datingScan['date']) && !empty($datingScan['date']) && !is_null($datingScan['date'])) ? date('d-m-Y', strtotime($datingScan['date'])) : '' }}" class="form-control input-width-medium"  name="datingdate" readonly /></td>
                                ...
                                <div class="col-md-7 plr-0 form-group row">
                                    <div class="col-md-12 custom-input">
                                        <table class="usg table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td  class="form-group"><input type="text" name="analogdate" value="{{ (isset($analogScan['date']) && !empty($analogScan['date']) && !is_null($analogScan['date'])) ? date('d-m-Y', strtotime($analogScan['date'])) : '' }}" class="form-control input-width-medium" readonly /></td>
                                        ...
                                        <table class="any-further-scan usg table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  class="form-group"><input type="text" value="{{ @unserialize($scanValue['Gestation']) !== false ? '' : $scanValue['Gestation'] }}" class="form-control input-width-medium"  name="othergestations[{{ $scanKey }}]" /></td>
                                    ...
                                    <div class="col-md-12 custom-input">
                                        <table class="doppler-scan usg table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach(array_values($dopplerScan) as $dopplerKey => $dopplerValue)
                                                <tr>
                        ...
                        <div class="widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        @php $sepsis_in_mother_type = $results->sepsis_in_mother_type;  @endphp  
                                        ...
                                        <table class="MaternalAntibiotics table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @else
                                                    @php $results->MaternalAntibiotics = ''; @endphp
                    ...
                    <div class="col-md-12 overflow-auto">
                        <div class="widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group dispaly_apgar"  @if($results->known_field == '2') style="display:none;" @endif>
                                <table>
                                    <tr>
                                        <td></td>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 custom-input">
                                    <table class="indication-add table table-add-more add-border-bottom">
                                        ...
                                        <tbody>
                                            @if(count($results->Indication) > 0 )
                                            @php $i = 0; @endphp
                                            @foreach($results->Indication as $key => $indication)
                                            <tr>
                                                <td class="full-width">{!! Form::select('Indication['.$key.']',['N/A'=>'N/A']+$delivery_indications,$indication,['class'=>'delivery-indications-search full-width', 'id'=>'delivery-indications-search-'.$i]) !!}</td>
                                                <td>
                                                    <span class="fa fa-trash btn btn-danger btn-view remove"></span>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="col-md-9 custom-input">
                                        <table class="drugs table table-add-more full-width-fix">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td  class="form-group">
                                                        {!! Form::select('resusciatation_drugs['.$key.']',[''=>'N/A']+ValuelistHelpers::resuscitationMedication(),$data,["class"=>"form-control input-width-xlarge"]) !!}
                                                    </td>
                                                    <td>
            ...
            <div role="tabpanel" class="tab-pane" id="newbornform">
                <div class="tabbable tabbable-custom">
                    <ul class="nav nav-tabs" role="tablist">
                        <!-- <li role="presentation" @if($_COOKIE['neonatal_proforma_sub'] == 'vitals') class="active" @endif> -->
                        <li role="presentation"class="active">
                            <a class="tab-sub-menu" href="#vitals" aria-controls="vitals" role="tab" data-toggle="tab">VITALS</a>
                        </li>
                        <!-- <li role="presentation" @if($_COOKIE['neonatal_proforma_sub'] == 'gpe') class="active" @endif> -->
                        <li role="presentation">
                            <a class="tab-sub-menu" href="#gpe" aria-controls="gpe" role="tab" data-toggle="tab">GPE</a>
                        </li>
                        <!-- <li role="presentation" @if($_COOKIE['neonatal_proforma_sub'] == 'cvs') class="active" @endif> -->
                        <li role="presentation">
                            <a class="tab-sub-menu" href="#cvs" aria-controls="cvs" role="tab" data-toggle="tab">CVS</a>
                        </li>
                        <!-- <li role="presentation" @if($_COOKIE['neonatal_proforma_sub'] == 'rs') class="active" @endif> -->
                        <li role="presentation">
                            <a class="tab-sub-menu" href="#rs" aria-controls="rs" role="tab" data-toggle="tab">RS</a>
                        </li>
                        <!-- <li role="presentation" @if($_COOKIE['neonatal_proforma_sub'] == 'abdomen') class="active" @endif> -->
                        <li role="presentation">
                            <a class="tab-sub-menu" href="#abdomen" aria-controls="abdomen" role="tab" data-toggle="tab">ABDOMEN</a>
                        </li>
                        <!-- <li role="presentation" @if($_COOKIE['neonatal_proforma_sub'] == 'cns') class="active" @endif> -->
                        <li role="presentation">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 mt-10">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <button type="submit" value="savedhere" name="savedhere" class="btn save-button-shadow  btn-primary btn-block form-control neonatal_save_btn_create" data-flag="1">
                    ...
                    <span>{!! $SavedhereText !!} & Next</span>
                </button>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
                <a href="{{ $actionUrl }}" class="btn save-button-shadow   btn-block form-control" onclick="$('form')[0].reset();">
            ...
            @endif
            @if(\Session::get('admission_module') == 'NICU_ADMISSION')
            <div class="col-md-3 col-sm-4 col-xs-12 @if(isset($_COOKIE['neonatal_proforma']) && $_COOKIE['neonatal_proforma'] != 'essform') hide @endif">
            ...
            @else
            <div class="col-md-3 col-sm-4 col-xs-12 @if(isset($_COOKIE['neonatal_proforma']) && $_COOKIE['neonatal_proforma'] != 'newbornform') hide @endif">
                <button  data-flag="2" type="submit" class="btn save-button-shadow print-tag btn-info btn-block form-control neonatal_save_btn_create">
                <i class="fa fa-tag" aria-hidden="true"></i>
                <span>Print Tag</span>
                </button>
            ...
            @endif
            @if(\Session::get('admission_module') == 'NICU_ADMISSION')
            <div class="col-md-3 col-sm-4 @if(isset($_COOKIE['neonatal_proforma']) && $_COOKIE['neonatal_proforma'] == 'essform') col-xs-12 @else col-xs-12 @endif">
            ...
            @else 
            <div class="@if(isset($_COOKIE['neonatal_proforma']) && $_COOKIE['neonatal_proforma'] == 'newbornform') col-md-3 col-sm-4 col-xs-12 @else col-md-3 col-sm-4 col-xs-12 @endif">
                <a href="{{ $actionUrl }}" class="btn save-button-shadow cancel-block btn-block form-control" onclick="$('form')[0].reset();">
                <i class="fa fa-exclamation-circle"></i> 
                <span>Cancel</span>
                </a>
    ...
    $(document).on('click', '.neonatal_save_btn_create', function(e){
        if ($('#neonatalPerforma-form').valid() === true) {
            ...
            $.ajax({
                ...
                url: "{{ action('Registration\NeonatalController@update',$results->NeonatalId) }}",
