...
{!! Form::hidden('pincode') !!}
@php
$doctor_master = [''=>'N/A']+ValuelistHelpers::mas_doctors_list();
@endphp
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 custom-input clear-xs">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            {!! Form::text('chronological_weeks',null,['class'=>'form-control']) !!}
                            <label for="total_chronological_weeks" generated="true" class="error help-block"></label>
                        </div>
                        <div class="col-xs-6">
                            {!! Form::text('chronological_day',null,['class'=>'form-control ']) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 custom-input clear-xs">
                    <div class="row corrected_age">
                        ...
                        <div class="col-xs-6">
                            {!! Form::text('corrected_weeks',null,['class'=>'form-control corrected-gestation-wks']) !!}
                            <label for="total_corrected_weeks" generated="true" class="error help-block"></label>
                        </div>
                        <div class="col-xs-6">
                            {!! Form::text('corrected_day',null,['class'=>'form-control corrected-gestation-days']) !!}
    ...
    <div class="mt-10 widget box">
        ...
        <div class="widget-content">
            <div class="form-group row">
                ...
                {!! Form::hidden('visit_module_name', 'bayley_op') !!}
            ...
            <div class="form-group row">
                <div class="col-md-3 text-right label-control">
                    {!! Form::label('visit_number',Lang::get('home.ip').':') !!}
                </div>
                <div class="col-md-9 custom-input">
                    {!! Form::text('visit_number',null,['class'=>'form-control']) !!}
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-3 text-right label-control">
            ...
            <div class="form-group row">
                <div class="col-md-3 text-right label-control mt-0">
                    {!! Form::label('relationship_to_child','Relationship to Child:') !!}
                </div>
                <div class="col-md-9 custom-input">
                    {!! Form::select('relationship_to_child',[''=>'N/A', 'Father'=>'Father', 'Mother'=>'Mother'],null,['class'=>'form-control']) !!}
                </div>
            </div>
            <div class="hidden">
                {!! Form::select('seenby',$doctor_master,null,['class'=>'form-control']) !!}
            </div>                                     
            <div class="form-group row">
                <div class="col-md-3 text-right label-control">
                ...
                <div class="col-md-9 custom-input">
                    <table class="seen-by-div table table-add-more full-width-fix">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    {!! Form::select('seen_by['.$key.']',$doctor_master,$seen_by,['class'=>'form-control full-width']) !!}
                                </td>
                                @if ($key > 0)                                             
                                <td>
                            ...
                            <tr>
                                <td>
                                    {!! Form::select('seen_by[]',$doctor_master,null,['class'=>'form-control full-width']) !!}
                                </td>
                            </tr>
                            @endif 
                            @else 
