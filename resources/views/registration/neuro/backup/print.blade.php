...
<div class="temp-container" id="neuro-report-print">
    <div class="temp-row">
        ...
        @if ($neuro_consultant_id == @$results->visit_from)
                        ...
                        <p>
                            <span style="font-size:14px">
                                <u>
                                    ...
                                    <strong>Early Childhood Interventionist, Infant feeding & Lactation Professional</strong>
                                </u>
                            </span>
                        </p>
                        <p>
            ...
            <div class="content-block pl-10-must">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 pl-10">
                    <ol class="@if ($screening_count == 1) list-none pl-0 @endif">
                        ...
                        <li>
                            <p class="m-0">Bayley Scales of Infant and Toddler Development<sup>TM</sup>, Fourth Edition <b>(Bayley<sup>TM</sup>-4)</b></p>
    ...
    <!-- <div class="clearfix"></div> -->
    @endif
    @if ((is_object($hnne) && $hnne->total_hnne_score != 0) || (is_object($hine) && $hine->total_hine_score != 0) || (isset($m_chat_score) || isset($m_chat_f_score)) || (isset($m_chat_f_score) && isset($m_chat_score) && $m_chat_score >= 3 && $m_chat_score <= 7) || $dasii || $results->ddst_interpretation_status != null || count($cbcl_result) > 0 || count(@$bayley_result) > 0 || (isset($issa_result->id) && $issa_result->total > 0) || (isset($cars_result->id) && $cars_result->total > 0))
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0 chart-avoid-page-break">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                @php $test_count++; @endphp
                                @endif 
                                @if(isset($cc_infant_results->pre_intervention_personal_social) && !empty($cc_infant_results->pre_intervention_personal_social))
                                <div class="col-md-12 col-sm-12 col-xs-12 pt-15">
                                    ...
                                    <table class="pl-25 table table-bordered table-responsive table-fixed" id="issa">
                                        <thead>
                                            <tr>
                                                ...
                                                @if(isset($cc_infant_results->post_intervention_personal_social) && !empty($cc_infant_results->post_intervention_personal_social))
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{$cc_infant_results->pre_intervention_personal_social}}</td>
                                                @if(isset($cc_infant_results->post_intervention_personal_social) && !empty($cc_infant_results->post_intervention_personal_social))
                                                <td>{{$cc_infant_results->post_intervention_personal_social}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Cognition</td>
                                                <td>{{$cc_infant_results->pre_intervention_cognition}}</td>
                                                @if(isset($cc_infant_results->post_intervention_cognition) && !empty($cc_infant_results->post_intervention_cognition))
                                                <td>{{$cc_infant_results->post_intervention_cognition}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Cognition Communication</td>
                                                <td>{{$cc_infant_results->pre_intervention_cognition_communication}}</td>
                                                @if(isset($cc_infant_results->post_intervention_cognition_communication) && !empty($cc_infant_results->post_intervention_cognition_communication))
                                                <td>{{$cc_infant_results->post_intervention_cognition_communication}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Fine Motor</td>
                                                <td>{{$cc_infant_results->pre_intervention_fine_motor}}</td>
                                                @if(isset($cc_infant_results->post_intervention_fine_motor) && !empty($cc_infant_results->post_intervention_fine_motor))
                                                <td>{{$cc_infant_results->post_intervention_fine_motor}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Gross Motor</td>
                                                <td>{{$cc_infant_results->pre_intervention_gross_motor}}</td>
                                                @if(isset($cc_infant_results->post_intervention_gross_motor) && !empty($cc_infant_results->post_intervention_gross_motor))
                                                <td>{{$cc_infant_results->post_intervention_gross_motor}}</td>
                                                @endif
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                @if(isset($cc_preschoolers_results->pre_intervention_personal_social) && !empty($cc_preschoolers_results->pre_intervention_personal_social))
                                <div class="col-md-12 col-sm-12 col-xs-12 pt-15">
                                    ...
                                    <table class="pl-25 table table-bordered table-responsive table-fixed" id="issa">
                                        <thead>
                                            <tr>
                                                <td>Domains</td>
                                                <td>Age Range (Pre Intervention)</td>
                                                @if(isset($cc_preschoolers_results->post_intervention_personal_social) && !empty($cc_preschoolers_results->post_intervention_personal_social))
                                                <td>Age Range (Post Intervention)</td>
                                                @endif
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="text-left">Personal Social</td>
                                                <td>{{$cc_preschoolers_results->pre_intervention_personal_social}}</td>
                                                @if(isset($cc_preschoolers_results->post_intervention_personal_social) && !empty($cc_preschoolers_results->post_intervention_personal_social))
                                                <td>{{$cc_preschoolers_results->post_intervention_personal_social}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Cognition</td>
                                                <td>{{$cc_preschoolers_results->pre_intervention_cognition}}</td>
                                                @if(isset($cc_preschoolers_results->post_intervention_cognition) && !empty($cc_preschoolers_results->post_intervention_cognition))
                                                <td>{{$cc_preschoolers_results->post_intervention_cognition}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Cognition Communication</td>
                                                <td>{{$cc_preschoolers_results->pre_intervention_cognition_communication}}</td>
                                                @if(isset($cc_preschoolers_results->post_intervention_cognition_communication) && !empty($cc_preschoolers_results->post_intervention_cognition_communication))
                                                <td>{{$cc_preschoolers_results->post_intervention_cognition_communication}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Fine Motor</td>
                                                <td>{{$cc_preschoolers_results->pre_intervention_fine_motor}}</td>
                                                @if(isset($cc_preschoolers_results->post_intervention_fine_motor) && !empty($cc_preschoolers_results->post_intervention_fine_motor))
                                                <td>{{$cc_preschoolers_results->post_intervention_fine_motor}}</td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td class="text-left">Gross Motor</td>
                                                <td>{{$cc_preschoolers_results->pre_intervention_gross_motor}}</td>
                                                @if(isset($cc_preschoolers_results->post_intervention_gross_motor) && !empty($cc_preschoolers_results->post_intervention_gross_motor))
                                                <td>{{$cc_preschoolers_results->post_intervention_gross_motor}}</td>
                                                @endif
                                            </tr>
                                        </tbody>
                                    </table>
