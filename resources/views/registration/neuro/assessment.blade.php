        ...
        <div class="mt-10 widget box">
            ...
            <div class="widget-content">
                <table class="table" style="margin: auto;">
                    @if(in_array('SCREENING_HNNE',$read_permission))   
                    <tr id="hnne_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_HINE',$read_permission))   
                    <tr id="hine_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_M_CHAT',$read_permission))   
                    <tr id="m-chat_tab">
                        <td>
                    ...
                    @endif
                     @if(in_array('SCREENING_DASII',$read_permission))   
                    <tr id="dasii_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_DDST',$read_permission))   
                    <tr id="ddst_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_CBCL',$read_permission))   
                    <tr id="cbcl_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_BAYLEY',$read_permission))   
                    <tr id="bayley_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_ISSA',$read_permission))   
                    <tr id="issa_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_CARS',$read_permission))   
                    <tr id="cars_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_INFANTS',$read_permission))   
                    <tr id="infants_tab">
                        <td>
                    ...
                    @endif
                    @if(in_array('SCREENING_PRESCHOOLERS',$read_permission))   
                    ...
                    @endif
                    @if(in_array('SCREENING_PEP3',$read_permission))   
                    <tr id="preschoolers_tab">
                        <td>
                            <a href="#" data-href="#pep3_form" aria-controls="pep3_form" role="tab" data-toggle="tab" class="btn btn-primary full-tab-view input-width-small check_gestation">
                                <span>PEP 3</span>
                            </a>
                        </td>
                    </tr>
