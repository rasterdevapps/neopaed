    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="assessment-container col-md-12 assessment-page-break" id="dasii-container">
                ...
                <div id="cluster-container" class="assessment-container col-md-12 assessment-page-break">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th colspan="5">
            ...
            <div class="assessment-container col-md-12 assessment-page-break" id="issa-container">
                @include('registration.neuro.assessment_print_header')
                <span id="assessment-status-7" class="hide">Status: {!! $issa_result['status'] !!}</span>
                <div id="issa-question-container" class="col-xs-12 plr-must-0 mt-15">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th colspan="2"><b>Items</b></th>
                                <th><b>Rarely <br/> Upto 20 % <br/> Score 1</b></th>
                                <th><b>Sometimes <br/> 21 - 40 % <br/> Score 2</b></th>
                                <th><b>Frequently <br/> 41 - 60 % <br/> Score 3</b></th>
                                <th><b>Mostly <br/> 61 - 80 % <br/> Score 4</b></th>
                                <th><b>Always <br/> 81 - 100 % <br/> Score 5</b></th>
                            </tr>
                        </thead>
                        @php $issa_problems = \ValuelistHelpers::issaQuestionTypes(); @endphp
                        <tbody>
                            @foreach($issa_question as $key => $category)
                            <tr>
                                <td colspan="6" class="bg-secondary">
                                    <h4 class="pull-left"><b>
                                        @if ($key == 1)
                                        I
                                        @elseif ($key == 2)
                                        II
                                ...
                                <td class="bg-secondary text-center">
                                    <b>Score: 
                                       @if ($key == 1)
                                       @php echo $issa_result['srr']; @endphp
                                       @elseif ($key == 2)
                                       @php echo $issa_result['er']; @endphp
                                       @elseif ($key == 3)
                                       @php echo $issa_result['slc']; @endphp
                                       @elseif ($key == 4)
                                       @php echo $issa_result['bp']; @endphp
                                       @elseif ($key == 5)
                                       @php echo $issa_result['sa']; @endphp
                                       @elseif ($key == 6)
                                       @php echo $issa_result['cc']; @endphp
                                       @endif
                                   </b>
                               </td>
                            </tr>
                            ...
                            <tr>
                                <td>{!! $item['id'] !!}</td>
                                <td>{!! $item['question'] !!}</td>
                                @php $score = $issa_result['answer'][$item['id']]; @endphp
                                <td><span class="{!! $score == 1 ? 'check' : '' !!}"></span></td>
                                <td><span class="{!! $score == 2 ? 'check' : '' !!}"></span></td>
                                <td><span class="{!! $score == 3 ? 'check' : '' !!}"></span></td>
                                <td><span class="{!! $score == 4 ? 'check' : '' !!}"></span></td>
                                <td><span class="{!! $score == 5 ? 'check' : '' !!}"></span></td>
                            </tr>
                            @endforeach
                            @endforeach
                        </tbody>
            ...
            <div class="assessment-container col-md-12 assessment-page-break " id="cc-infants-container">
                   @include('registration.neuro.assessment_print_header')
                <div>
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th width="10"></th>
                                <th>Curriculum Sequence</th>
                                <th colspan="6">0-3 Months</th>
                                <th colspan="6">3-6 Months</th>
                                <th colspan="5">6-9 Months</th>
                                <th colspan="5">9-12 Months</th>
                                <th colspan="3">12-15 Months</th>
                                <th colspan="4">15-18 Months</th>
                                <th colspan="4">18-21 Months</th>
                                <th colspan="5">21-24 Months</th>
                                <th colspan="7">24-30 Months</th>
                                <th colspan="7">30-36 Months</th>
                            
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td rowspan="7" class="row-head">Personal-Social</td>
                                <td><strong>1. Self-Regulations & Responibility</strong></td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'a') }}">a</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'b') }}">b</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'c') }}">c</td>
                                <td colspan="6" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'd') }}">d</td>
                                <td colspan="5" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'e') }}">e</td>
                                <td colspan="5" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'f') }}">f</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'h') }}">h</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'i') }}">i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'j') }}">j</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'k') }}">k</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'l') }}">l</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'm') }}">m</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'n') }}">n</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_regulation_responsibility', 'o') }}">o</td>
                            </tr>
                            <tr>
                                <td><strong>2. Interpersonal Skills</strong></td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'a') }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'b') }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'c') }}">c</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'd') }}">d</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'e') }}">e</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'h') }}">h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'i') }}">i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'k') }}">k</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'l') }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'n') }}">n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'o') }}">o</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'p') }}">p</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'q') }}">q</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'r') }}">r</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 's') }}">s</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 't') }}">t</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'u') }}">u</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'v') }}">v</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'w') }}">w</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'x') }}">x</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'y') }}">y</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'z') }}">z</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'aa') }}">aa</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'interpersonal_skills', 'bb') }}">bb</td>
                            </tr>
                            <tr>
                                <td><strong>3. Self-Concept</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'a')  }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'b')  }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'c')  }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'd')  }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'e')  }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'f')  }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'g')  }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'h')  }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'i')  }}">i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'j')  }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'k')  }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'l')  }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'm')  }}">m</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'n')  }}">n</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'o')  }}">o</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'p')  }}">p</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'q')  }}">q</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 'r')  }}">r</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 's')  }}">s</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_concept', 't')  }}">t</td>
                            </tr>
                            <tr>
                                <td><strong>4-I. Self Help: Eating</strong></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'a')  }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'b')  }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'c')  }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'd')  }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'e')  }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'f')  }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'g')  }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'h')  }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'i')  }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'j')  }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'k')  }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'l')  }}">l</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'm')  }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'n')  }}">n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'o')  }}">o</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'p')  }}">p</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'q')  }}">q</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'r')  }}">r</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 's')  }}">s</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 't')  }}">t</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'u')  }}">u</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'v')  }}">v</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'w')  }}">w</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'x')  }}">x</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'y')  }}">y</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_eating', 'z')  }}">z</td>
                            </tr>
                            <tr>
                                <td><strong>4-II. Self Help: Dressing</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'a') }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'c') }}">c</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'e') }}">e</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'f') }}">f</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'j') }}">j</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'k') }}">k</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_dressing', 'l') }}">l</td>
                            </tr>
                            <tr>
                                <td><strong>4-III. Self Help: Grooming</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'a') }}">a</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'c') }}">c</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'd') }}">d</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'e') }}">e</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'g') }}">g</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'h') }}">h</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'i') }}">i</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_grooming', 'j') }}">j</td>
                            </tr>
                            <tr>
                                <td><strong>4-III. Self Help: Tioleting</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"></td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'a') }}">a</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'b') }}">b</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'c') }}">c</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'd') }}">d</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'e') }}">e</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'f') }}">f</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'self_help_tioleting', 'g') }}">g</td>
                            </tr>
                            <tr>
                                <td rowspan="6"  class="row-head" style="border-bottom: none">COGNITION</td>
                                <td><strong>5. Attention & Memory: Visual/Spatial</strong></td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'a') }}">a</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'c') }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'g') }}">g</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'j') }}">j</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'l') }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'm') }}">m</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'n') }}">n</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'o') }}">o</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'p') }}" >p</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'q') }}" >q</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'r') }}">r</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 's') }}">s</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 't') }}">t</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'u') }}">u</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'v') }}">v</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'w') }}">w</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'x') }}">x </td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'y') }}">y </td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'z') }}">z</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'aa') }}">aa</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'bb') }}">bb</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'cc') }}">cc</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'dd') }}">dd</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'ee') }}">ee</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'ff') }}">ff</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'gg') }}">gg</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_memory', 'hh') }}">hh</td>
                            </tr>
                            <tr>
                                <td><strong>6-I. Visual Perception: Blocks & Puzzles</td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'a') }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'c') }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'd') }}">d</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'e') }}">e</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'i') }}">i</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'j') }}">j</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'k') }}">k </td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'l') }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'm') }}">m</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_blocks', 'n') }}">n</td>
                            </tr>
                            <tr>
                                <td><strong>6-II.Visual Perception: Matching & Sorting
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                ...
                                <td colspan="4"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_matching', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_matching', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_matching', 'c') }}">c</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_perception_matching', 'd') }}">d</td>
                            </tr>
                            <tr>
                                <td><strong>7. Functional use of Objects & Symbolic Pay </strong></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'b') }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'e') }}">e</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'h') }}">h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'i') }}">i</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'j') }}">j</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'k') }}">k</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'l') }}">l</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'n') }}">n</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'o') }}">o</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'p') }}">p</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'q') }}">q</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'functional_use', 'r') }}">r</td>
                            </tr>
                            <tr>
                                <td><strong>8. Problem Solving/Reasoning</strong></td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'a') }}" >a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'b') }}" >b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'c') }}" >c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'd') }}" >d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'e') }}" >e</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'f') }}" >f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'g') }}" >g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'h') }}" >h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'i') }}" >i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'j') }}" >j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'k') }}" >k</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'l') }}" >l</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'm') }}" >m</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'n') }}" >n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'o') }}" >o</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'p') }}" >p</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'q') }}" >q</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'r') }}" >r</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 's') }}" >s</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 't') }}" >t</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'u') }}" >u</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'v') }}" >v</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'w') }}" >w</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'x') }}" >x </td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'y') }}" >y</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'z') }}" >z</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'problem_solving', 'aa') }}">aa</td>
                            </tr>
                            <tr>
                                <td><strong> 9. Number Concept</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                ...
                                <td colspan="4"></td>
                                <td colspan="4"></td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'number_concept', 'a') }}" >a</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'number_concept', 'b') }}" >b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'number_concept', 'c') }}" >c</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'number_concept', 'd') }}" >d</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'number_concept', 'e') }}" >e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'number_concept', 'f') }}" >f</td>
                            </tr>

                            <tr>
                                <td rowspan="3" class="row-head" style="border-bottom:none; border-top:none;">COG / COMM</td>
                                <td><strong>10. Concepts/Vocabulary: Receptive</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'a') }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'i') }}">i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'j') }}">j</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'l') }}">l</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'n') }}">n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'o') }}">o</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'p') }}">p</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'q') }}">q</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'r') }}">r</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 's') }}">s</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 't') }}">t</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'u') }}">u</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_receptive', 'v') }}">v</td>
                            </tr>
                            <tr>
                                <td><strong>11.Concepts/Vocabulary: Expressive</strong></td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'b') }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'e') }}">e</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'g') }}">g</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'h') }}">h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'i') }}">i</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'j') }}">j</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'k') }}">k</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'l') }}">l</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'n') }}">n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'o') }}">o</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'p') }}">p</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'q') }}">q</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'concepts_vocabulary_expressive', 'r') }}">r</td>
                            </tr>
                            <tr>
                                <td><strong> 12. Attention & Memory: Auditory</strong></td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'a') }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'b') }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'h') }}">h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'i') }}">i</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'j') }}">j</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'k') }}">k</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'l') }}">l</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'n') }}">n</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'o') }}">o</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'p') }}">p</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'q') }}">q</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'r') }}">r</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 's') }}">s</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 't') }}">t</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'attention_auditory', 'u') }}">u</td>
                            </tr>
                            <tr>
                                <td rowspan="4" class="row-head" style="border-top: none;">COMM</td>
                                <td><strong>13. Verbal Comprehension</strong></td>
                                <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'f') }}">f</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'g') }}">g</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'i') }}">i</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'j') }}">j</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'k') }}">k</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'l') }}">l</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'm') }}">m</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'n') }}">n</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'verbal_comprehension', 'o') }}">o</td>
                            </tr>
                            <tr>
                                <!-- <td>Communication</td> -->
                                <td><strong>14. Conversational Skills</strong></td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'a') }}">a</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'c') }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'k') }}">k</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'l') }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'm') }}">m</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'n') }}">n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'o') }}">o</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'p') }}">p</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'q') }}">q</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'r') }}">r</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 's') }}">s</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 't') }}">t</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'u') }}">u</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'v') }}">v</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'w') }}">w</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'x') }}">x</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'y') }}">y</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'z') }}">z</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'aa') }}">aa</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'bb') }}">bb</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'cc') }}">cc</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'dd') }}">dd</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'ee') }}">ee</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'ff') }}">ff</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'gg') }}">gg</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'hh') }}">hh</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'ii') }}">ii</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'jj') }}">jj</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'kk') }}">kk</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'conversational_skills', 'll') }}">ll</td>
                            </tr>
                            <tr>
                                <td><strong> 15. Grammatical Structure</td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"></td>
                                <td colspan="4"></td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'a') }}">a</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'g') }}">g</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grammatical_sructure', 'k') }}">k</td>
                            </tr>
                            <tr>
                                <td><strong> 16. Imitation: Vocal</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'b') }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'e') }}">e</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'f') }}">f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'h') }}">h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'l') }}">l</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'm') }}">m</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'n') }}">n</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'o') }}">o</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'p') }}">p</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_vocal', 'q') }}">q</td>
                            </tr>
                            <tr>
                                <td rowspan="5" class="row-head">FINE MOTOR</td>
                                <td><strong> 17.Imitation: Motor</td>
                                <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'a') }}" >a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'b') }}" >b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'c') }}" >c</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'd') }}" >d</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'e') }}" >e</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'f') }}" >f</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'g') }}" >g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'h') }}" >h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'i') }}" >i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'j') }}" >j</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'k') }}" >k</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'l') }}" >l</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'm') }}" >m</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'imitation_motor', 'n') }}" >n</td>
                            </tr>
                            <tr>
                                <td><strong>18. Grasp & Manipulation</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'a') }}">a</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'c') }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'l') }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'm') }}">m</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'n') }}">n</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'o') }}">o</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'p') }}">p</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'q') }}">q</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'r') }}">r</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 's') }}">s</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 't') }}">t</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'u') }}">u</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'v') }}">v</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'w') }}">w</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'x') }}">x</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'y') }}">y</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'z') }}">z</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'aa')}}">aa</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'grasp_manipulation', 'bb') }}">bb</td>
                            </tr>
                            <tr>
                                <td><strong>19. Bilateral Skills</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'b') }}">b</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'c') }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'g') }}">g</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'i') }}">i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'j') }}">j</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'l') }}">l</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'n') }}">n</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'o') }}">o</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'p') }}">p</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'q') }}">q</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'r') }}">r</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 's') }}">s</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 't') }}">t</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'bilateral_skills', 'u') }}">u</td>
                            </tr>
                            <tr>
                                <td><strong>20. Tool Use</td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'a') }}">a</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'b') }}">b</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'c') }}">c</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'd') }}">d</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'e') }}">e</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'f') }}">f</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'tool_use', 'j') }}">j</td>
                            </tr>
                            <tr>
                                <td><strong>21. Visual-Motor Skills</td>
                                <td colspan="6"  ></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'a') }}">a</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'b') }}">b</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'c') }}">c</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'e') }}">e</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'f') }}">f</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'visual_motor_skills', 'j') }}">j</td>
                            </tr>
                            <tr>
                                <td rowspan="6"  class="row-head">GROSS MOTOR</td>
                                <td><strong>21-I. Upriqht: Posture & Locomotion</td>
                                <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'a') }}">a</td>
                                <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'h') }}">h</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'i') }}">i</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'l') }}">l</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'm') }}">m</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'n') }}">n</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'o') }}">o</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'p') }}">p</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'q') }}">q</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'r') }}">r</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 's') }}">s</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 't') }}">t</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'u') }}">u</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'v') }}">v</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'w') }}">w</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'x') }}">x </td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'y') }}">y </td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'z') }}">z</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'aa') }}">aa</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'bb') }}">bb</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'cc') }}">cc</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'dd') }}">dd</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'ee') }}">ee</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'ff') }}">ff</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'gg') }}">gg</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_posture_locomotion', 'hh') }}">hh</td>
                            </tr>
                            <tr>
                                <td><strong>22-II. Upright: Balance</td>
                                <td colspan="6"  ></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"></td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'a') }}">a</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'b') }}">b</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'c') }}">c</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'd') }}">d</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'e') }}">e</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'g') }}">g</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_balance', 'j') }}">j</td>
                            </tr>
                            <tr>
                                <td><strong>22-III. Upriqht: Ball Play</td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"></td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'a') }}">a</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'c') }}">c</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'd') }}">d</td>
                                <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'e') }}">e</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'f') }}">f</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'g') }}">g</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'h') }}">h</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_ball_play', 'i') }}">i</td>
                            </tr>
                            <tr>
                                <td><strong>22-IV. Upright: Outdoor Play</td>
                                <td colspan="6"></td>
                                <td colspan="6"></td>
                                <td colspan="5"></td>
                                <td colspan="5"></td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'a') }}">a</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'b') }}">b</td>
                                <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'c') }}">c</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'd') }}">d</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'e') }}">e</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'f') }}">f</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'h') }}">h</td>
                                <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'upright_outdoor_play', 'i') }}">i</td>
                            </tr>
                            <tr>
                                <td><strong>23. Prone (on Stomach)</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'a') }}">a</td> 
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'b') }}">b</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'c') }}">c</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'd') }}">d</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'e') }}">e</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'f') }}">f</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'g') }}">g</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'h') }}">h</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'i') }}">i</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'j') }}">j</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'k') }}">k</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'l') }}">l</td>
                                <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'm') }}">m</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'n') }}">n</td>
                                <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'o') }}">o</td>
                                <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'prone', 'p') }}">p</td>
                                <td colspan="4"></td>
                                <td colspan="4"></td>
                                <td colspan="5"></td>
                                <td colspan="7"></td>
                            ...
                            <tr>
                                <td><strong>24. Supine (on Back)</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'a') }}">a</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'b') }}">b</td>
                                <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'c') }}">c</td>
                                <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'd') }}">d</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'e') }}">e</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'f') }}">f</td>
                                <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_infant_results, 'supine', 'g') }}">g</td>
                                <td colspan="5" ></td>
                                <td colspan="5" ></td>
                                <td colspan="3" ></td>
                                <td colspan="4" ></td>
            ...
            <div class="assessment-container col-md-12 assessment-page-break" id="cc-preschoolers-container">
                @include('registration.neuro.assessment_print_header')
                <div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th colspan="7">24-30 Months</th>
                                <th colspan="7">30-36 Months</th>
                                <th colspan="9">36-42 Months</th>
                                <th colspan="6">42-48 Months</th>
                                <th colspan="7">48-54 Months</th>
                                <th colspan="5">54-60 Months</th>
                            </tr>
                        </thead>
                        <tbody>
                        <tr>
                        <td rowspan="7" class="row-head">Personal-Social</td>
                        <td><strong>1. Self-Regulations & Responibility</strong></td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'a') }}">a</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'b') }}">b</td>
                        <td colspan="7" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'c') }}">c</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'd') }}">d</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'e') }}">e</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'f') }}">f</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'g') }}">g</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'h') }}">h</td>
                        <td colspan="4" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'i') }}">i</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'j') }}">j</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'k') }}">k</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_regulation_responsibility', 'l') }}">l</td>
                        </tr>
                        <tr>
                        <td><strong>2. Interpersonal Skills</strong></td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'a') }}">a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'c') }}">c</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'd') }}">d</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'e') }}">e</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'f') }}">f</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'g') }}">g</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'h') }}">h</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'i') }}">i</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'j') }}">j</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'k') }}">k</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'l') }}">l</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'm') }}">m</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'n') }}">n</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'o') }}">o</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'p') }}">p</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'q') }}">q</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'r') }}">r</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 's') }}">s</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 't') }}">t</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'u') }}">u</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'v') }}">v</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'w') }}">w</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'x') }}">x</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'y') }}">y</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'z') }}">z</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'aa') }}">aa</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'bb') }}">bb</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'interpersonal_skills', 'cc') }}">cc</td>
                        </tr>
                        <tr>
                        <td><strong>3. Self-Concept</strong></td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'b') }}">b</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'c') }}">c</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'd') }}">d</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'e') }}">e</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'f') }}">f</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'g') }}">g</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'h') }}">h</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'i') }}">i</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'j') }}">j</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'k') }}">k</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'l') }}">l</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'm') }}">m</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_concept', 'n') }}">n</td>
                        </tr>
                        <tr>
                        <td><strong>4-I. Self Help: Eating</strong></td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'a') }}" >a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'b') }}" >b</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'c') }}" >c</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'd') }}" >d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'e') }}" >e</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'f') }}" >f</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'g') }}" >g</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'h') }}" >h</td>
                        <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_eating', 'i') }}" >i</td>
                        <tr>
                        <td><strong>4-II. Self Help: Dressing</strong></td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'a') }}">a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'b') }}">b</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'c') }}">c</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'd') }}">d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'e') }}">e</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'f') }}">f</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'g') }}">g</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'h') }}">h</td>
                        <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_dressing', 'i') }}">i</td>
                        </tr>
                        <tr>
                        <td><strong>4-III. Self Help: Grooming</strong></td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'a') }}">a</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'b') }}">b</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'c') }}">c</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'd') }}">d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'e') }}">e</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'f') }}">f</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'g') }}">g</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'h') }}">h</td>
                        <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_grooming', 'i') }}">i</td>
                        </tr>
                        <tr>
                        <td><strong>4-III. Self Help: Tioleting</strong></td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'a') }}">a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'b') }}">b</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'c') }}">c</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'd') }}">d</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'e') }}">e</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'f') }}">f</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'g') }}">g</td>
                        <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'self_help_tioleting', 'h') }}">h</td>
                        </tr>
                        <tr>
                        <td rowspan="6" class="row-head" style="border-bottom: none">COGNITION</td>
                        <td><strong>5. Attention & Memory: Visual/Spatial</strong></td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'a') }}">a</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'b') }}">b</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'c') }}">c</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'd') }}">d</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'e') }}">e</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'f') }}">f</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'g') }}">g</td>
                        <td colspan="6" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'h') }}">h</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'i') }}">i</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'j') }}">j</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'k') }}">k</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'l') }}">l</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'm') }}">m</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'n') }}">n</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'o') }}">o</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'p') }}">p</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'q') }}">q</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 'r') }}">r</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_memory', 's') }}">s</td>
                        </tr>
                        <tr>
                        <td><strong>6-I. Visual Perception: Blocks & Puzzles</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'a') }}">a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'c') }}">c</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'd') }}">d</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'e') }}">e</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'f') }}">f</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'g') }}">g</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'h') }}">h</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'i') }}">i</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'j') }}">j</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'k') }}">k</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'l') }}">l</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_blocks', 'm') }}">m</td>
                        </tr>
                        <tr>
                        <td><strong>6-II.Visual Perception: Matching & Sorting
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'a') }}">a</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'b') }}">b</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'c') }}">c</td>
                        <td colspan="7"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'd') }}">d</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'e') }}">e</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'f') }}">f</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'g') }}">g</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'h') }}">h</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'i') }}">i</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'j') }}">j</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'k') }}">k</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'l') }}">l</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'm') }}">m</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_perception_matching', 'n') }}">n</td>
                        </tr>
                        <tr>
                        <td><strong>7. Functional use of Objects & Symbolic Pay </strong></td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'c') }}">c</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'd') }}">d</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'e') }}">e</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'f') }}">f</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'g') }}">g</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'h') }}">h</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'i') }}">i</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'j') }}">j</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'k') }}">k</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'functional_use', 'l') }}">l</td>
                        </tr>
                        <tr>
                        <td><strong>8. Problem Solving/Reasoning</strong></td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'b') }}">b</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'c') }}">c</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'd') }}">d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'e') }}">e</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'f') }}">f</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'g') }}">g</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'h') }}">h</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'i') }}">i</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'j') }}">j</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'k') }}">k</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'l') }}">l</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'm') }}">m</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'n') }}">n</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'o') }}">o</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'p') }}">p</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'q') }}">q</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 'r') }}">r</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 's') }}">s</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'problem_solving', 't') }}">t</td>
                        </tr>
                        <tr>
                        <td><strong> 9. Number Concept</strong></td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'a') }}">a</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'b') }}">b</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'c') }}">c</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'd') }}">d</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'e') }}">e</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'f') }}">f</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'g') }}">g</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'h') }}">h</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'i') }}">i</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'j') }}">j</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'k') }}">k</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'l') }}">l</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'm') }}">m</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'n') }}">n</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'o') }}">o</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'p') }}">p</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'q') }}">q</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'r') }}">r</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 's') }}">s</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 't') }}">t</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'u') }}">u</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'v') }}">v</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'w') }}">w</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'number_concept', 'x') }}">x</td>
                        </tr>
                        <tr>
                        <td rowspan="3"class="row-head" style="border-bottom:none; border-top:none;">COG/ COMM</td>
                        <td><strong>10. Concepts/Vocabulary: Receptive</strong></td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'b') }}">b</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'c') }}">c</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'd') }}">d</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'e') }}">e</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'f') }}">f</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'g') }}">g</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'h') }}">h</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'i') }}">i</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'j') }}">j</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'k') }}">k</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'l') }}">l</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'm') }}">m</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'n') }}">n</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'o') }}">o</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'p') }}">p</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'q') }}">q</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'r') }}">r</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 's') }}">s</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 't') }}">t</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'u') }}">u</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'v') }}">v</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'w') }}">w</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'x') }}">x</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'y') }}">y</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'z') }}">z</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'aa') }}">aa</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'bb') }}">bb</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_receptive', 'cc') }}">cc</td>
                        </tr>
                        <tr>
                        <td><strong>11.Concepts/Vocabulary: Expressive</strong></td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'c') }}">c</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'd') }}">d</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'e') }}">e</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'f') }}">f</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'g') }}">g</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'h') }}">h</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'i') }}">i</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'j') }}">j</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'k') }}">k</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'l') }}">l</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'm') }}">m</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'n') }}">n</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'o') }}">o</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'p') }}">p</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'q') }}">q</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'r') }}">r</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 's') }}">s</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 't') }}">t</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'u') }}">u</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'concepts_vocabulary_expressive', 'v') }}">v</td>
                        </tr>
                        <tr>
                        <td><strong> 12. Attention & Memory: Auditory</strong></td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'a') }}">a</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'b') }}">b</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'c') }}">c</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'd') }}">d</td>
                        <td colspan="6"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'e') }}">e</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'f') }}">f</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'g') }}">g</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'h') }}">h</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'i') }}">i</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'j') }}">j</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'k') }}">k</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'attention_auditory', 'l') }}">l</td>
                        </tr>
                        <tr>
                        <td rowspan="4" class="row-head" style="border-top: none;" >COMM</td>
                        <td><strong>13. Verbal Comprehension</strong></td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'a') }}">a</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'b') }}">b</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'c') }}">c</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'd') }}">d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'e') }}">e</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'f') }}">f</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'g') }}">g</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'h') }}">h</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'i') }}">i</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'j') }}">j</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'k') }}">k</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'l') }}">l</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'verbal_comprehension', 'm') }}">m</td>
                        </tr>
                        <tr>
                        <td><strong>14. Conversational Skills</strong></td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'a') }}">a</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'b') }}">b</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'c') }}">c</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'd') }}">d</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'e') }}">e</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'f') }}">f</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'g') }}">g</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'h') }}">h</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'i') }}">i</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'j') }}">j</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'k') }}">k</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'l') }}">l</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'm') }}">m</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'n') }}">n</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'o') }}">o</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'p') }}">p</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'q') }}">q</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'r') }}">r</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 's') }}">s</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 't') }}">t</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'u') }}">u</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'v') }}">v</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'conversational_skills', 'w') }}">w</td>
                        </tr>
                        <tr>
                        <td><strong> 15. Grammatical Structure</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'c') }}">c</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'd') }}">d</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'e') }}">e</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'f') }}">f</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'g') }}">g</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'h') }}">h</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'i') }}">i</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'j') }}">j</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'k') }}">k</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'l') }}">l</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'm') }}">m</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'n') }}">n</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'o') }}">o</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'p') }}">p</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'q') }}">q</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'r') }}">r</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 's') }}">s</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 't') }}">t</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'u') }}">u</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grammatical_sructure', 'v') }}">v</td>
                        </tr>
                        <tr>
                        <td><strong> 16. Imitation: Vocal</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_vocal', 'a') }}">a</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_vocal', 'b') }}">b</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_vocal', 'c') }}">c</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_vocal', 'd') }}">d</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_vocal', 'e') }}">e</td>
                        <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_vocal', 'f') }}">f</td>
                        </tr>
                        <tr>
                        <td rowspan="5" class="row-head">FINE MOTOR</td>
                        <td><strong> 17.Imitation: Motor</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_motor', 'a') }}">a</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_motor', 'b') }}">b</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_motor', 'c') }}">c</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_motor', 'd') }}">d</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_motor', 'e') }}">e</td>
                        <td colspan="5"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'imitation_motor', 'f') }}">f</td>
                        </tr>
                        <tr>
                        <td><strong>18. Grasp & Manipulation</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'a') }}">a</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'b') }}">b</td>
                        <td colspan="7"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'c') }}">c</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'd') }}">d</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'e') }}">e</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'f') }}">f</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'g') }}">g</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'h') }}">h</td>
                        <td colspan="7"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'i') }}">i</td>
                        <td colspan="5"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'grasp_manipulation', 'j') }}">j</td>
                        </tr>
                        <tr>
                        <td><strong>19. Bilateral Skills</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'a') }}">a</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'c') }}">c</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'd') }}">d</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'e') }}">e</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'f') }}">f</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'g') }}">g</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'h') }}">h</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'i') }}">i</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'j') }}">j</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'k') }}">k</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'l') }}">l</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'bilateral_skills', 'm') }}">m</td>
                        </tr>
                        <tr>
                        <td><strong>20. Tool Use</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'a') }}">a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'c') }}">c</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'd') }}">d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'e') }}">e</td>
                        <td colspan="9"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'f') }}">f</td>
                        <td colspan="6"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'g') }}">g</td>
                        <td colspan="7"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'h') }}">h</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'i') }}">i</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'tool_use', 'j') }}">j</td>
                        </tr>
                        <tr>
                        <td><strong>21. Visual-Motor Skills</td>
                        <td colspan="4"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'a') }}">a</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'b') }}">b</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'c') }}">c</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'd') }}">d</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'e') }}">e</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'f') }}">f</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'g') }}">g</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'h') }}">h</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'i') }}">i</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'j') }}">j</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'k') }}">k</td>
                        <td colspan="3"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'l') }}">l</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'm') }}">m</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'n') }}">n</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'o') }}">o</td>
                        <td colspan="2"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'p') }}">p</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'visual_motor_skills', 'q') }}">q</td>
                        </tr>
                        <tr>
                        <td rowspan="6" class="row-head">GROSS MOTOR</td>
                        <td><strong>21-I. Upriqht: Posture & Locomotion</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'a') }}">a</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'b') }}">b</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'c') }}">c</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'd') }}">d</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'e') }}">e</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'f') }}">f</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'g') }}">g</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'h') }}">h</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'i') }}">i</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'j') }}">j</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'k') }}">k</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'l') }}">l</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'm') }}">m</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'n') }}">n</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'o') }}">o</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'p') }}">p</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'q') }}">q</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'r') }}">r</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 's') }}">s</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 't') }}">t</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'u') }}">u</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'v') }}">v</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'w') }}">w</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'x') }}">x</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'y') }}">y</td>
                        <td colspan="1" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'z') }}">z</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'aa') }}">aa</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'bb') }}">bb</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'cc') }}">cc</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'dd') }}">dd</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'ee') }}">ee</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'ff') }}">ff</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'gg') }}">gg</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'hh') }}">hh</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'ii') }}">ii</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'jj') }}">jj</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'kk') }}">kk</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'll') }}">ll</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'mm') }}">mm</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'nn') }}">nn</td>
                        <td colspan="1"  class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_posture_locomotion', 'oo') }}">oo</td>
                        </tr>
                        <tr>
                        <td><strong>22-II. Upright: Balance</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'a') }}">a</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'b') }}">b</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'c') }}">c</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'd') }}">d</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'e') }}">e</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'f') }}">f</td>
                        <td colspan="9"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'g') }}">g</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'h') }}">h</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'i') }}">i</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'j') }}">j</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'k') }}">k</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'l') }}">l</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'm') }}">m</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'n') }}">n</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'o') }}">o</td>
                        <td colspan="1"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_balance', 'p') }}">p</td>
                        </tr>
                        <tr>
                        <td><strong>22-III. Upriqht: 8all Play</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'a') }}">a</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'b') }}">b</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'c') }}">c</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'd') }}">d</td>
                        <td colspan="6"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'e') }}">e</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'f') }}">f</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'g') }}">g</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'h') }}">h</td>
                        <td colspan="2"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'i') }}">i</td>
                        <td colspan="4"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'j') }}">j</td>
                        <td colspan="3"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'k') }}">k</td>
                        <td colspan="5"   class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_ball_play', 'l') }}">l</td>
                        </tr>
                        <tr>
                        <td><strong>22-IV. Upright: Outdoor Play</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'a') }}">a</td>
                        <td colspan="2" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'b') }}">b</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'c') }}">c</td>
                        <td colspan="7" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'd') }}">d</td>
                        <td colspan="6" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'e') }}">e</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'f') }}">f</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'g') }}">g</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'h') }}">h</td>
                        <td colspan="4" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'i') }}">i</td>
                        <td colspan="3" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'j') }}">j</td>
                        <td colspan="5" class="{{ SiteHelpers::checkCarolinaCurriculumGetColor($cc_preschoolers_results, 'upright_outdoor_play', 'k') }}">k</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<div class="modal fade" id="assessment-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            @if (!($hnne_details->total_hnne_score != 0 || $hine_details->total_hine_score != 0 || $m_chat_score != null || $results->cluster_range != null || $results->ddst_interpretation_status != null || count($cbcl_result) > 0 || isset($cc_infant_results) || isset($cc_preschoolers_results)))
            ...
            @else
                <div class="modal-header" style="display: flex; flex-direction: row;">
                    <div id="infants-container" class="mt-15">
                ...
                <div class="modal-body m-10">
                    <table>
                        ...
                        @endif
                        @if (count($issa_result['answer']) > 0)
                        <tr>
                            <td>{!! Form::checkbox('assessment_list[]', 'ISSA', true) !!}</td>
                            <td>ISSA</td>
                        </tr>
                        @endif
                        @if (isset($cc_infant_results) && !empty($cc_infant_results))
                        <tr>
                            <td>{!! Form::checkbox('assessment_list[]','CC-Infants', true) !!}</td>
                            <td>CC Infant</td>
                        </tr>
                        @endif
                        @if (isset($cc_preschoolers_results) && !empty($cc_preschoolers_results))
                        <tr>
                            <td>{!! Form::checkbox('assessment_list[]','CC-Preschoolers', true) !!}</td>
                            <td>CC Preschoolers</td>
                        </tr>
                        @endif
                    </table>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#generate-btn').on('click', function() {
            ...
            $("input:checked").each(function(){
                ...
                console.log(assessment_container_name);
        ...
        var assessment_status_7 = $('#assessment-status-7').html();
        ...
        $('#issa-container .assessment-score').addClass('hide');
        $('#cluster-container .assessment-score').addClass('hide');
        $('#cc-infants-container .assessment-block').addClass('hide');
        $('#cc-preschoolers-container .assessment-block').addClass('hide');
        ...
        $('#issa-container .assessment-status').html(assessment_status_7);
    ...
    $(document).on('click', '#btn-assessment-reset', function() {
        ...
        $('#issa-container').addClass('assessment-page-break').removeClass('display-block-must');
        $('#cluster-container').addClass('assessment-page-break').removeClass('display-block-must');

        $('.assessement-header-container').addClass('assessement-header');  
        $('#cc-infants-container').addClass('assessment-page-break').removeClass('display-block-must');
        $('#cc-preschoolers-container').addClass('assessment-page-break').removeClass('display-block-must');
