...
<div class="row row-spacing select-container-main">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <div class="row select-option-container">
            <div class="col-md-12">
                {!! Form::hidden('action_url', action('Registration\NeuroController@create')) !!}
            ...
            <div class="col-md-12 mt-15">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <a href="{{ action('Registration\NeuroController@index') }}" class="cancel-btn clear-flow-sesstion save-button-shadow  btn btn-default form-control btn-block" onclick="$('form')[0].reset();">
