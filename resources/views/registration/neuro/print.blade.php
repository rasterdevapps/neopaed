    ...
    <div class="temp-row row">
         @if(($neuro_consultant_id == @$results->visit_from) || ($pvs == @$results->visit_from))
            <div class="col-md-6 col-xs-6">
                <img src="{{url('public/img/pixie-logo.png') }}"  class="img-responsive" alt="Pixie Logo">
            </div>
        @endif
        <div class="col-md-6 col-xs-6">
           @if(isset($results->neuro_visit_id))
            <img src="{{ SiteHelpers::getOpLogo() }}" class="img-responsive">
            @endif
        </div>
            ...
            <table style="margin-bottom: 0px;">
                <tr>
                    <td class="vertical-top" style="border: 0px !important;">
                        ...
                        <p>
                            <strong>Ms.Keerthana S</strong> Msc.,MPhil Clinical Psychology (IMH)
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <table style="margin-bottom: 0px;">
                <tr>
                    <td class="vertical-top" style="border: 0px !important;">
                        ...
                        <p>
                            <strong>Mrs Nivetha .J</strong> M.Sc.,ACD; ACLP <br>
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <table style="margin-bottom: 0px;">
                <tr>
                    <td class="vertical-top" style="border: 0px !important;">
                        ...
                        <p>
                            <strong>Ms Parimala M</strong> M.Sc., ACD; B.Sc Psy
                        </p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td class="vertical-top" style="border: 0px !important;">
                        <p>
                            <span style="font-size:14px">
                                <u>
                                    <strong>Occupational Therapist</strong>
                                </u>
                            </span>
                        </p>
                        <p>
                            <strong>Ms Dhanushya A</strong> B.O.T., M.O.T (Pediatrics)<br>
            ...
            <table style="margin-bottom: 0px;">
                <tr>
                    <td class="vertical-top" style="border: 0px !important;">
                        ...
                        <p>
                            <strong>Ms C Kamali </strong> B.P.T
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <div class="content-block pl-10-must">
                ...
                <div class="col-md-5 col-sm-12 col-xs-12 plr-must-0">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        @endif
                        @if (!empty($results->caregiver_assessment))
                        <div class="form-group">
                            <div>
                                <span class="print-label-text">Caregiver in assessment::</span> 
                                <span class="print-label-value">{!! $results->caregiver_assessment; !!}</span>
                            </div>
                        </div>
                        @endif
                        @if (!empty($results->hour_of_intervention))
                        <div class="form-group">
                            <div>
                                <span class="print-label-text">Hours of Intervention:</span> 
                                <span class="print-label-value">{!! $results->hour_of_intervention; !!}</span>
                            </div>
                        </div>
                        @endif
                        @if (!empty($results->referal_doctor))
                        <div class="form-group">
                            <span class="print-label-text">Referal Doctor:</span> 
                            <span class="print-label-value">{!! $results->referal_doctor; !!}</span>
                        </div>
                        @endif
                    </div>
                </div>
      ...
      @if ((is_object($hnne) && $hnne->total_hnne_score != 0) || (is_object($hine) && $hine->total_hine_score != 0) || isset($m_chat_score) || $dasii || $results->ddst_interpretation_status != null || count(@$bayley_result) > 0 || (isset($issa_result->id) && $issa_result->total > 0) || (isset($cars_result->id) && $cars_result->total > 0) || isset($pep_result) && !empty($pep_result))
      <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="content-block pl-10-must">
                <h5 class="mt-0 mb-5"> 
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 pl-10">
                    <ol class="@if ($screening_count == 1) list-none pl-0 @endif">
                        ...
                        @endif
                        @if (isset($pep_result) && !empty($pep_result) && !empty($pep_result->cvp_raw_score))
                        <li>Psychodeucational Profile Third edition</li>
                        @endif
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0 chart-avoid-page-break">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                @if (isset($issa_result->id) && $issa_result->total > 0)
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <h5 class="mt-0 mb-5"><strong>{{$test_count}}. Indian Scale for Assessment of Autism (ISSA)</strong></h5>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 pt-15">
                                    <h5 class="mt-0 mb-5"><strong>{{$test_count}}. Childhood Autism Rating Scale (CARS)</strong></h5>
                                ...
                                @if(isset($pep_result) && !empty($pep_result) && !empty($pep_result->cvp_raw_score))
                                <div class="col-md-12 col-sm-12 col-xs-12 pt-15">
                                    <h5 class="mt-0 mb-5"><strong>{{$test_count}}. Psychodeucational Profile Third edition</strong></h5>
                                    <h4><b>Record of Subtest Scores</b></h4>
                                    <table class="table table-bordered table-responsive table-fixed" id="record-subtest-score">
                                        <thead>
                                            <tr>
                                                <td>Performance Subtest</td>
                                                <td>Raw Score</td>
                                                <td>Developmental Age</td>
                                                <td>%ile Rank</td>
                                                <td>Developmental / adaptive level</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="vertical-align-middle">Cognitive/Verbal/Preverbal</td>
                                                <td>{!! $pep_result->cvp_raw_score !!}</td>
                                                <td>{!! $pep_result->cvp_developemental_age !!}</td>
                                                <td>{!! $pep_result->cvp_rank !!}</td>
                                                <td>{!! $pep_result->cvp_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Expressive Language</td>
                                                <td>{!! $pep_result->el_raw_score !!}</td>
                                                <td>{!! $pep_result->el_developemental_age !!}</td>
                                                <td>{!! $pep_result->el_rank !!}</td>
                                                <td>{!! $pep_result->el_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Receptive Language</td>
                                                <td>{!! $pep_result->rl_raw_score !!}</td>
                                                <td>{!! $pep_result->rl_developemental_age !!}</td>
                                                <td>{!! $pep_result->rl_rank !!}</td>
                                                <td>{!! $pep_result->rl_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Fine motor</td>
                                                <td>{!! $pep_result->fm_raw_score !!}</td>
                                                <td>{!! $pep_result->fm_developemental_age !!}</td>
                                                <td>{!! $pep_result->fm_rank !!}</td>
                                                <td>{!! $pep_result->fm_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Gross Motor</td>
                                                <td>{!! $pep_result->gm_raw_score !!}</td>
                                                <td>{!! $pep_result->gm_developemental_age !!}</td>
                                                <td>{!! $pep_result->gm_rank !!}</td>
                                                <td>{!! $pep_result->gm_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Visual motor imitation</td>
                                                <td>{!! $pep_result->vmi_raw_score !!}</td>
                                                <td>{!! $pep_result->vmi_developemental_age !!}</td>
                                                <td>{!! $pep_result->vmi_rank !!}</td>
                                                <td>{!! $pep_result->vmi_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Affective expression</td>
                                                <td>{!! $pep_result->ae_raw_score !!}</td>
                                                <td>{!! $pep_result->ae_developemental_age !!}</td>
                                                <td>{!! $pep_result->ae_rank !!}</td>
                                                <td>{!! $pep_result->ae_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Social reciprocity</td>
                                                <td>{!! $pep_result->sr_raw_score !!}</td>
                                                <td>{!! $pep_result->sr_developemental_age !!}</td>
                                                <td>{!! $pep_result->sr_rank !!}</td>
                                                <td>{!! $pep_result->sr_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Characteristics motor behaviour</td>
                                                <td>{!! $pep_result->cmb_raw_score !!}</td>
                                                <td>{!! $pep_result->cmb_developemental_age !!}</td>
                                                <td>{!! $pep_result->cmb_rank !!}</td>
                                                <td>{!! $pep_result->cmb_development_adaptive_level !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Characteristics verbal behaviour</td>
                                                <td>{!! $pep_result->cvb_raw_score !!}</td>
                                                <td>{!! $pep_result->cvb_developemental_age !!}</td>
                                                <td>{!! $pep_result->cvb_rank !!}</td>
                                                <td>{!! $pep_result->cvb_development_adaptive_level !!}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <h4><b>Record of Composite Scores</b></h4>
                                    <table class="table table-bordered" id="record-composite-score">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{!! $pep_result->com_standard_score !!}</td>
                                                <td>{!! $pep_result->com_rank !!}</td>
                                                <td>{!! $pep_result->com_development_adaptive_level !!}</td>
                                                <td>{!! $pep_result->com_developemental_age !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Motor</td>
                                                <td>{!! $pep_result->motor_standard_score !!}</td>
                                                <td>{!! $pep_result->motor_rank !!}</td>
                                                <td>{!! $pep_result->motor_development_adaptive_level !!}</td>
                                                <td>{!! $pep_result->motor_developemental_age !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="vertical-align-middle">Maladaptive behaviours</td>
                                                <td>{!! $pep_result->mb_standard_score !!}</td>
                                                <td>{!! $pep_result->mb_rank !!}</td>
                                                <td>{!! $pep_result->mb_development_adaptive_level !!}</td>
                                                <td>{!! $pep_result->mb_developemental_age !!}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0 mt-15">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center fontweight">
                            <div class="pull-right">
                                ...
                                $seen_by = \ValuelistHelpers::signatureFormat($seen_by, 3);
                                @endphp
                                {!! $seen_by !!}
                                @endif                     
                            </div>
