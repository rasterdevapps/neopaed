...
} elseif(isset($_COOKIE['daycare']) && Session::has('registration_start')) {
    $_COOKIE['daycare'] = 'generalform'; 
}
@endphp
<!-- Breadcrumbs line -->
...
@php ValuelistHelpers::setOldinputs('nicu-daycare') @endphp
@endif
<div class="row row-spacing">
    <div class="col-md-12">
        {!! Form::model($baby,['url' => action('Admission\DaycareController@store'),'id'=> 'daycare-form']) !!}
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('DayOfLife','',['class'=>'form-control', 'readonly']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input clear-xs">
                                        <div class="row col-md-12 display-flex">
                                            <div>
                                                <small>(In Weeks)</small>
                                                {!! Form::text('cg_weeks','',['class'=>'form-control input-width-medium corrected-gestation-wks', 'readonly']) !!}
                                            ...
                                            <div>
                                                <small>(In Days)</small>
                                                {!! Form::text('cg_days','',['class'=>'form-control  input-width-medium corrected-gestation-days', 'readonly']) !!}
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input clear-xs">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                {!! Form::select('DayTime',$admission['time'],$baby->time_hour,['class'=>'form-control']) !!}
                                                <label for="DayTime" generated="true" class="error help-block"></label>
                                            </div>
                                            <div class="col-xs-4">
                                                {!! Form::select('DayTime_MINS',$admission['mins'],$baby->time_mins,['class'=>'form-control']) !!}
                                                <label for="DayTime_MINS" generated="true" class="error help-block"></label>
                                            </div>
                                            <div class="col-xs-4">
                                                {!! Form::select('DayTime_AM',[''=>'N/A','AM'=>'AM','PM'=>'PM'],$baby->time_session,['class'=>'form-control']) !!}
                                ...
                                <div class="form-group row mx-0 problems-container">
                                    ...
                                    <input type="hidden" name="CurrentProblems" id="hidden_current_problem" value="@if(isset($baby->CurrentProblems) && !empty($baby->CurrentProblems)) {{ $baby->CurrentProblems  }} @endif">
                                    <div class="water-mark">Add Current Problem</div>
                                    <ul class="connected-sortable droppable-area1">
                                        @if(isset($baby->CurrentProblems) && !empty($baby->CurrentProblems))
                                        <?php 
                                        $current_problem = explode('||', $baby->CurrentProblems);
                               ...
                               <div class="form-group row mx-0 problems-container">
                                ...
                                <input type="hidden" name="PreviousProblems" id="hidden_prev_problem" value="@if(isset($baby->PreviousProblems) && !empty($baby->PreviousProblems)) {{ $baby->PreviousProblems }} @endif">
                                <div class="water-mark">Add Previous Problem</div>
                                <ul class="connected-sortable droppable-area2">
                                    @if(isset($baby->PreviousProblems) && !empty($baby->PreviousProblems))
                                    <?php 
                                    $prev_problem = explode('||', $baby->PreviousProblems);
                ...
                <div class="widget box mt-10">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('Retractions',[''=>'N/A','No'=>'No','Mild'=>'Mild','Moderate'=>'Moderate','Severe'=>'Severe'],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('Retractions')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control  md-mt-50">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('ChestMovement',[''=>'N/A','Symmetrical'=>'Symmetrical','Asymmetrical'=>'Asymmetrical'],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('ChestMovement')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control  md-mt-50">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('AddedSounds',[''=>'N/A','Present'=>'Present','Absent'=>'Absent'],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('AddedSounds')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                ...
                <div class="widget box mt-10">
                    ...
                    <div class="widget-content">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('TypeOfBloodGas',[''=>'N/A','Not done'=>'Not done','Arterial'=>'Arterial','Venous'=>'Venous','Capillary'=>'Capillary','Not indicated'=>'Not indicated'],'',['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control" style="margin-top: 25px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('EtTube',[''=>'N/A','Yes'=>'Yes','No'=>'No'],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('Size',[''=>'N/A','None'=>'None','2.0'=>'2.0','2.5'=>'2.5','3.0'=>'3.0','3.5'=>'3.5','4.0'=>'4.0'],'',['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                <input id="needlethoracentesis" name="needlethoracentesis" data-on="Yes" data-off="No"  data-toggle="toggle" data-width="100" data-size="small" class="form-control" type="checkbox">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                            ...
                            <div class="col-md-9 custom-input">
                                <input id="intercostaldrain" name="intercostaldrain" data-on="Yes" data-off="No"  data-toggle="toggle" data-width="100" data-size="small" class="form-control" type="checkbox">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                            ...
                            <div class="col-md-9 custom-input">
                                <input id="chronic_lung" name="chronic_lung" data-on="Yes" data-off="No"  data-toggle="toggle" data-width="100" data-size="small" class="form-control" type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget box mt-10">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('PulsePressure',[''=>'N/A','Normal'=>'Normal','Wide'=>'Wide'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('PulsePressure')])
                                !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('CentralPulses',[''=>'N/A','Normal'=>'Normal','Bounding'=>'Bounding','Feeble/Weak'=>'Feeble/Weak','Absent'=>'Absent'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('PeripheralPulses')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('PeripheralPulses',[''=>'N/A','Normal'=>'Normal','Bounding'=>'Bounding','Feeble/Weak'=>'Feeble/Weak','Absent'=>'Absent'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('PeripheralPulses')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('FemoralPulses',[''=>'N/A','Normal'=>'Normal','Bounding'=>'Bounding','Feeble/Weak'=>'Feeble/Weak','Absent'=>'Absent'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('PeripheralPulses')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control md-mt-50">
                            ...
                            <div class="col-md-9 custom-input">
                                {!!  Form::select('PrecordialActivity',[''=>'N/A','Present'=>'Present','Absent'=>'Absent'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('default')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control md-mt-50">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('S1S2',[''=>'N/A','Normal'=>'Normal','Abnormal'=>'Abnormal'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control md-mt-50">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('Murmur',[''=>'N/A','Present'=>'Present','Absent'=>'Absent'],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('default')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control mt-0">
                ...
                <div class="widget box mt-10">
                    ...
                    <div class="widget-content">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('CFT',[''=>'N/A','< 3 Seconds' => "< 3 Seconds",'3-5 Seconds' => "3-5 Seconds",'>5 Seconds' => ">5 Seconds","Prolonged"=>"Prolonged"],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('sp_ven')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        {!! Form::text('central_temp_farenheit',null,['class'=>'form-control fahrenheit', 'id' => 'central_temp_farenheit']) !!}
                                    </div>
                                    <div class="col-xs-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        {!! Form::text('peripheral_fahrenheit',null,['class'=>'form-control fahrenheit', 'id'=>'peripheral_fahrenheit']) !!}
                                    </div>
                                    <div class="col-xs-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('Color',[''=>'N/A','Pale'=>'Pale','Pink' => "Pink","Acral Cyanosis"=>"Acral Cyanosis","Central Cyanosis"=>"Central Cyanosis"],'',['class'=>' form-control']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control md-mt-50">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('Inotropes',[''=>'N/A','No' =>"No","Yes"=>"Yes"],'',['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('Inotropes')]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control mt-0">
        ...
        <div role="tabpanel" class="tab-pane @if($_COOKIE['daycare'] == 'gasform') active @endif" id="gasform">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="widget box mt-10">
                    ...
                    <div class="widget-content">
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control mt-0" style="padding-left: 9px;">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control mt-0" style="padding-left: 7px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input">
                                {!! Form::select('Frequency',ValuelistHelpers::frequencyList(),'',['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 text-right label-control mt-0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 custom-input clear-xs">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Tpn',[''=>'N/A','No' =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control mt-0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('AspirateNature',[''=>'N/A','Nil' =>"Nil","Milky"=>"Milky","Yellow"=>"Yellow","Light green"=>"Light green","Dark green"=>"Dark green","Bloody"=>"Bloody","Altered brown"=>"Altered brown","Clear"=>"Clear"],'',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Abdomen',[''=>'N/A','Normal'=>'Normal','Scaphoid'=>'Scaphoid','Distended'=>'Distended'],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('Abdomen')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control md-mt-50">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('BowelSounds',[''=>'N/A','Normal'=>"Normal","Increased"=>"Increased","Decreased"=>"Decreased","Absent"=>"Absent"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('BowelSounds')])
                                        !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Umbilicus',[''=>'N/A','Healthy' => "Healthy","Possible infection"=>"Possible infection","Omphalitis"=>"Omphalitis","Omphalocele"=>"Omphalocele","Gastroschisis"=>"Gastroschisis","Hernia"=>"Hernia","Meconium Stained" => "Meconium Stained","Large" => "Large","Shrivelled" => "Shrivelled"],'',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control md-mt-50">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Hepatomegaly',[""=>"N/A","No" =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Splenomegaly',[""=>"N/A","No" =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Herina',[''=>'N/A','No hernia' => "No hernia","Right Inguinal hernia"=>"Right Inguinal hernia","Left Inguinal hernia"=>"Left Inguinal hernia","Umbilical/para umbilical hernia"=>"Umbilical/para umbilical hernia","Obstructed/strangulated"=>"Obstructed/strangulated"],'',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('AnteriorFontanelle',[""=>"N/A","Normal" =>"Normal","Depressed"=>"Depressed","Bulging"=>"Bulging"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('AnteriorFontanelle')])
                                        !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Activity',[""=>"N/A","Normal" =>"Normal","Comatosed"=>"Comatosed","Decreased"=>"Decreased","Increased"=>"Increased","Irritable"=>"Irritable","Sedated/Paralysed"=>"Sedated/Paralysed"],'',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Tone',[""=>"N/A",'Normal' =>"Normal","Hypotonia"=>"Hypotonia","Hypertonia"=>"Hypertonia","Sedated/Paralysed"=>"Sedated/Paralysed"],'',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Cry',ValuelistHelpers::cryValues(),'N/A',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control md-mt-50">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Seizures',[""=>"N/A",'No' =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3 text-center label-control mt-0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        <input id="Hypocalcemia" name="Hypocalcemia" data-on="Yes" data-off="No"  data-toggle="toggle" data-width="100" data-size="small" class="form-control" type="checkbox">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-center label-control">
                                    ...
                                    <table class="product table table-add-more full-width-fix">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="input-width-mini form-control"
                                                    name="F_Volume[]" value="{!! $data['Volume']; !!}"/></td>
                        ...
                        <div role="tabpanel" class="tab-pane @if($_COOKIE['daycare'] == 'sepsisform') active @endif" id="sepsisform">
                                            ...
                                            <table class="antibiotic table table-add-more full-width-fix table-layout-fixed">
                                                <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="full-width">{!! Form::select('A_Antibiotic[]',['0'=>'N/A']+ValuelistHelpers::getDrugIvFluidsAntibiotic(),@$data['Antibiotic'],['class'=>"form-control sepsis-antibiotic"]) !!}</td>
                                                            <td class="input-width-mini"><input type="text" class="input-width-mini form-control" name="A_Day[]" value="{!! $data['Day']; !!}"/></td>
                                    ...
                                    <div class="widget box mt-10">
                                        ...
                                        <div class="widget-content">
                                                ...
                                                <div class="col-md-9 custom-input">
                                                    <table class="sep_drugs table table-add-more full-width-fix table-layout-fixed">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="full-width">{!! Form::select('drugs[]',['0'=>'N/A']+ValuelistHelpers::getDrugIvFluidsNonAntibiotic(),$data,['class'=>"form-control sepsis-non-antibiotic"]) !!}</td>
                                                                <td class="input-width-mini"><span class="fa fa-trash btn btn-danger btn-view remove"></span></td>
                                                            </tr>
                                                            @endforeach
                                                            @else
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 custom-input">
                                                    {!! Form::select('BloodCulture',[''=>'N/A','Not sent' => "Not sent","Awaited"=>"Awaited","Negative"=>"Negative","Positive"=>"Positive"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('BloodCulture')]) !!}
                                                </div>
                                            </div>
                                            <div class="hidden">
                                                    ...
                                                    <table class="organizam table table-add-more full-width-fix">
                                                        <thead>
                                                            <tr class="master-add-header">
                                                                ...
                                                                <th><a class="btn btn-success btn-view organizam_add btn_add" href="javascript:void(0);"><i class="fa fa-plus"></i></a></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 custom-input">
                                                    {!! Form::select('lumbar_puncture',['Performed'=>'Performed','Not Performed' => "Not Performed","Not Indicated"=>"Not Indicated"],'Not Indicated',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('BloodCulture')]) !!}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-3 text-right label-control">
                                                ...
                                                <div class="col-md-9 custom-input">
                                                    {!! Form::select('Meningitis',ValuelistHelpers::meningitisValue(),'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('Meningitis')]) !!}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-3 text-right label-control">
                            ...
                            <div role="tabpanel" class="tab-pane @if($_COOKIE['daycare'] == 'invasform') active @endif" id="invasform">
                                    ...
                                    <div class="widget box mt-10">
                                        ...
                                        <div class="widget-content">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 custom-input">
                                                    {!! Form::select('PeripheralCannula',[''=>'N/A','No' => "No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                                </div>
                                            </div>
                                <!-- <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Picc',[''=>'N/A','No' =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Uvc',[""=>"N/A","No" =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control md-mt-50">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('UvcPosition',[""=>"N/A","High" =>"High","Low"=>"Low"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Uac',[''=>'N/A','No' =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control md-mt-50">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('UacPosition',[''=>'N/A','High' =>"High","Low"=>"Low"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Pac',[''=>'N/A','No' =>"No","Yes"=>"Yes"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('default_normal')]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('PacSite',[''=>'N/A',"Rt Radial" => "Rt Radial","Lt Radial"=>"Lt Radial","Rt Ulnar"=>"Rt Ulnar","Lt Ulnar"=>"Lt Ulnar","Rt Posterior Tibial"=>"Rt Posterior Tibial","Lt Posterior Tibial"=>"Lt Posterior Tibial","Rt Dorsalis Pedis"=>"Rt Dorsalis Pedis","Lt Dorsalis Pedis"=>"Lt Dorsalis Pedis"],'',['class'=>'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                ...
                <div class="col-md-11 col-sm-12">
                    <input type="hidden" name="print_flag" @if($_COOKIE['daycare'] == 'ropform' || $_COOKIE['daycare'] == 'notesform') value="0" @else value="2" @endif  id="print_flag"/>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <button type="submit" class="btn btn-block btn-primary save-button-shadow form-control daycare_save_btn" data-flag="0"><i class="fa fa-floppy-o"></i>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="{{ action('Admission\DaycareController@index') }}" class="btn btn-block btn-default save-button-shadow form-control" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> <span>Cancel</span></a>
                    </div>
                    @else 
                    <div class="@if($_COOKIE['daycare'] == 'ropform' || $_COOKIE['daycare'] == 'notesform' || $_COOKIE['daycare'] == 'reassessment') col-md-3  @else col-md-6 col-sm-4 @endif set-column">
                        <button type="button" class="btn btn-block btn-info save-next save-button-shadow form-control" onclick="$('#print_flag').val('2'); $('#daycare-form').submit();"><i class="fa fa-floppy-o" ></i>
                            <span>@if($_COOKIE['daycare'] == 'ropform' || $_COOKIE['daycare'] == 'notesform' || $_COOKIE['daycare'] == 'reassessment') Finish @else Next @endif</span>
                        </button>
                    </div>
                    <div class="@if($_COOKIE['daycare'] == 'ropform' || $_COOKIE['daycare'] == 'notesform' || $_COOKIE['daycare'] == 'reassessment') col-md-3  @else hide @endif print-tag">
                    ...
                    <div class="@if($_COOKIE['daycare'] == 'ropform' || $_COOKIE['daycare'] == 'notesform' || $_COOKIE['daycare'] == 'reassessment') col-md-3  @else col-md-6 col-sm-4 col-xs-12 @endif set-column">
...
<!-- <div class="sidebar-right panel panel-default">
    <div class="">
        <h3>Search</h3>
        <div class="form-group row">
...
<script type="text/javascript">
    ...
    if(current_active_tab == 'notesform')
    {
    ...
    $('.save-next').click(function() {
       ...
       if (daycareId != 'ropform' || daycareId != 'notesform') {
...
$(document).on('click', '.daycare_save_btn', function(e){
    if ($('#daycare-form').valid() === true) {
        ...
        $.ajax({
            ...
            url: "{{ action('Admission\DaycareController@store') }}",
            success: function (response) {
                if (print_flag == 1) {
                    Showalert('success', 'Daycare Details Stored Successfully');
                ...
                {
                    Showalert('success', 'Daycare Details Stored Successfully');
                    window.location.href = response.daycare_edit_next_url;
                }
                else
                {
                    Showalert('success', 'Daycare Details Stored Successfully');
...
$('input[name="DayDate"], select[name="DayTime"], select[name="DayTime_MINS"], select[name="DayTime_AM"]').on('change', function(e) {
    getTodayMachineRecords();
});

getTodayMachineRecords();

function getTodayMachineRecords() {
    var date = $('input[name="DayDate"]').val();
    var hours = $('select[name="DayTime"]').val();
    hours = hours.length > 1 ? hours : '0' + hours;
    var mins = $('select[name="DayTime_MINS"]').val();
    mins = mins.length > 1 ? mins : '0' + mins;
    var session = $('select[name="DayTime_AM"]').val();
    
    var baby_id = $('input[name="baby_id"]').val();
    var admission_id = $('input[name="admission_id"]').val();
    
    var select_date_time = date + ' ' + hours + ':' + mins + ' ' + session;
    ...
    $.ajax({
        ...
        type: 'GET',
        data: {baby_id: baby_id, admission_id: admission_id, select_date_time: select_date_time},
        ...
        success: function (response) {
            ...
            $.each(daycare_id, function(index, value) {
                if (value == 'peripheral_fahrenheit') {
                    console.log(value);
                    console.log(results[value]);
                    $('#peripheral_fahrenheit').val(results[value]).trigger('input');
                } else if (value == 'InvasiveVentilation') {
                    $('#InvasiveVentilation').val(results[value]).trigger('change');
                } else if (value == 'Ventilation_choose') {
                    $('#Ventilation_choose').val(results[value]).trigger('change');
                } else if (value == 'NonInvasiveVentilation') {
                    $('#NonInvasiveVentilation').val(results[value]).trigger('change');
                } else if (value == 'ModeOfVentilation') {
                    $('#ModeOfVentilation').val(results[value]).trigger('change');
                } else {
                    $('input[name="'+value+'"]').val(results[value]);
                }
            });
        }
    });
