...
<head>
    ...
    <!-- Login -->
    <link href="{{ $site_url}}/css/login.css?rev=<?php echo time();?>" rel="stylesheet" type="text/css"/>
    ...
    <div class="box">
        <div class="box-content">
            <div class="logo-content text-center">
                <img src="{{ $site_url }}/img/neonatal_logo.png" class="project-logo" /> <br/>
                <!-- <h1><strong>Neo</strong>paed</h1> -->
                <!-- Login Formular -->
                {!! Form::open(['method' => 'POST','url' => 'login','class'=>'form-vertical login-form']) !!}
                <!-- Logo -->
                <div class="logo">
                    <img src="{{ $site_url }}/img/sks_logo.png" alt="logo" width="250px" height="100%" />
                </div>
                <!-- /Logo -->
                <!-- Title -->
        ...
        <a href="https://www.raster.in/" style="display: flex; flex-direction: row; align-items: flex-end; color: black;"><img src="{{ $site_url}}/img/raster_logo.svg" alt="Company" /><span style="padding: 0px 10px;">Raster Images (P) Ltd.</span></a>
    </div>
    <!-- /Login Box -->
</body>
...
<script type="text/javascript" src="{{ $site_url}}/plugins/uniform/jquery.uniform.min.js"></script>
<!-- Form Validation -->
<script type="text/javascript" src="{{ $site_url}}/plugins/validation/jquery.validate.min.js"></script>
<!-- Slim Progress Bars -->
<script type="text/javascript" src="{{ $site_url}}/plugins/nprogress/nprogress.js"></script>
<!-- App -->
<script type="text/javascript" src="{{ $site_url}}/js/login.js?rev=<?php echo time();?>"></script>
<script>
