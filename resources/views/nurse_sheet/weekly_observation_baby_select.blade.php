...
<div class="crumbs bread-crumbs-shadow">
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li><a href="javascript:void(0);">Weekly Observation Report</a></li>
	...
	<div class="col-md-6 col-sm-6 col-xs-6">
        <div class="row select-option-container">
            ...
            <div class="col-md-12 ">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <a href="{{ action('Nurse\NurseSheetController@weeklyObservationBabySelect') }}" class="cancel-btn btn save-button-shadow btn-default form-control btn-block" onclick="$('form')[0].reset();">
...
$(document).ready(function() {
    ...
    $(".submittbtn").click(function() {
        ...
        if (selectval != 0) {
            ...
            window.location = "{{ url('nicu-nurse-sheets/get-weekly-observations') }}/" + selectval + "/0?closewinlink=main";
        } else {
