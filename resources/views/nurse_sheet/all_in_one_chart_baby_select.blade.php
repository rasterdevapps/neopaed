...
<div class="crumbs bread-crumbs-shadow">
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li><a href="javascript:void(0);">All In One Chart</a></li>
	...
	<div class="col-md-6 col-sm-6 col-xs-6">
        <div class="row select-option-container">
            ...
            <div class="col-md-12 ">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <a href="{{ action('Nurse\NurseSheetController@allInOneChartBabySelect') }}" class="cancel-btn btn save-button-shadow btn-default form-control btn-block" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> <span>Cancel</span></a>
                </div>
            </div>                           
        </div>
	</div> <!-- /.col-md-12 -->
...
$(document).ready(function() {
	...
	$(".submittbtn").click(function() {
		...
		if (selectval != 0) {
		    ...
		    window.location = "{{ url('multiple-chart/') }}/" + baby_id + "/" + selectval + "/0/main";
		} else {
