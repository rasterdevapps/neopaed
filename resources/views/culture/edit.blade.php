...
<div class="row row-spacing">
    {!! Form::model($results,['method' => 'PATCH','url' => action('Extras\CultureController@update',$results->CultureId), 'id'=>'culture-registry']) !!}
    @include('errors.list')
    <div class="col-md-12">
        <div role="tabpanel" class="tabbable tabbable-custom">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class=""><a href="#Penicillinform" role="tab" data-toggle="tab">Penicillin</a></li>
            ...
            <div class="tab-content tab-view-shadow">
                <div class="active tab-pane" role="tabpanel" id="Basicform">
                        ...
                        <div class="mt-10 widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('Gestation',null,['class'=>'form-control','readonly']) !!}
                                    </div>
                        ...
                        <div class="mt-10 widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('CollectionDate',null,['class'=>'form-control datepicker', 'readonly']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                ...
                <div class="col-md-11 col-sm-12">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <button type="submit" class="btn btn-primary save-button-shadow form-control btn-block culture-save-btn"><i class="fa fa-floppy-o"></i> <span>{!! $SubmitButtonText !!}</span></button>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
...
$(document).on('click', '.culture-save-btn', function(e){
    if ($('#culture-registry').valid() === true) {
        ...
        $.ajax({
            ...
            url: "{{ action('Extras\CultureController@update',$results->CultureId) }}",
