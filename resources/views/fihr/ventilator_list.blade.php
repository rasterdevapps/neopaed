...
<div class="crumbs bread-crumbs-shadow">
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li class="current">
			<a href="{{ action('Fhir\FhirFormattedValuesController@ventilatordata') }}">Ventilator Values</a>
		</li>                                         
	</ul>
</div>
		...
		<div class="widget box table-view-shadow">
			...
			<div class="widget-content">
							...
							<div class="col-xs-4 col-sm-6 col-md-6">
								<div id="data-list_length" class="dataTables_length">
									<label class="data_limit">
										{{ Form::open(['url' => action('Fhir\FhirFormattedValuesController@ventilatordata'), 'method' => 'get', 'id' => 'limit-form']) }}
				...
				<div class="col-md-12 mt-15 mb-20 p-10 multi-search display-grid" style="border: 1px solid #dddddd; float: unset;">
					{{ Form::model($search, ['url' => action('Fhir\FhirFormattedValuesController@ventilatordata'), 'method' => 'get', 'id' => 'filter-ventilator']) }}
					<div class="col-md-2">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							{!! Form::select('devicename',['N/A'=>'N/A', 'SLE5000'=>'SLE5000', 'SLE6000'=>'SLE6000'],null,['class'=>'form-control']) !!}
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
					...
					<div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;align-items: center;height: 70px;">
						<button class="btn btn-primary save-button-shadow ventilator-data-filter mr-10"> Search </button>
				...
				<table class="table table-striped table-bordered table-responsive" id="data-list">
					...
					<tbody>
						...
						<tr class="detailinfo">
							...
							<td><a href="{{ url('fhir-format-value'.'/'.SiteHelpers::encrypt_id($list->ventilator_id)) }}/ventilator:{{$list->status}}">{{ date('d-m-Y H:i',strtotime($list->issued)) }}</a></td>                    
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="dataTables_paginate paging_bootstrap pagination_footer">
									<ul class="pagination">
										...
										$current_url = url('/ventilator-values/');
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".ventilator-data-filter").on("click", function() {
			$("#filter-ventilator").validate({
				rules:{
					mrno:{
						required: true
					}
		...
		function pagination(sortby) {
			...
			var sorting_param  = $('#limit-form').serialize();
			var searchinput  = $('#filter-ventilator').serialize();
		...
		$('.reset').click(function() {
			var form = $('#filter-ventilator').get(0);
