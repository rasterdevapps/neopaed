            ...
            <div class="row mx-0">
                <div class="col-md-12 change-column-width @if($summary_type != 'interimiframe') widget box @endif">
                    ...
                    <div class="widget-header">
                        <h4><i class="fa fa-reorder"></i> Original Summary</h4>
                    </div>
                ...
                <div class="widget box interim-summary-widget col-md-6 px-0" style="display: none;">
                    ...
                    <div class="widget-content">
                        ...
                        <textarea name="interim_summary" id="interim_summary" style="display: none; width: 100%">
                        </textarea>
                        <div id="interim_summary_original_content" class="hide"></div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            $('.open-compare').on('click', function() {
                ...
                $.ajax({
                      ...
                      type    :"GET",
                      url     : "{{ url('nicu-abbrivated-summary/'.Request::segment(2)) }}/interimiframe",
                      success:function(response) {
                            
                          $('#interim_summary_original_content').html(response);
                          var summary_content = $('#interim_summary_original_content .nicu-discharge-report').html();
                          $('#interim_summary').val(summary_content);
                          // CKEDITOR.replace( 'interim_summary' );
