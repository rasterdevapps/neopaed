...
<div class="temp-container nicu-discharge-report">
    <div class="temp-row">
        <!-- BEGIN HEADER CONTENT -->
        <div class="ml-15 @if(isset($headerContent['header_required']) && $headerContent['header_required'] == 1) hide @endif text-center">
            <img src="{!! SiteHelpers::getNicuLogo($result->NicuId) !!}">
        </div>
        ...
        <div class="">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="row" style="margin-bottom:15px;">
                    <!-- <span class="col-xs-4 col-sm-6 col-md-6">
                        <span><b>Neonatal Paediatrician :</b></span>
                    </span>
                    <div class="col-xs-9 col-sm-12">
                        {!! str_replace('~', ',', $result->neonatal_consultant) !!}
                    </div> -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 daycare-summary-content plr-must-0-screen">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-print">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group">
                                <span class="print-label">UHID:</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group">
                                <span class="print-label">IP Number:</span>
                            ...
                            <div class="form-group">
                                ...
                                <span class="print-value">{!! $result->AdmissionDate !!}</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <span class="print-value">{!! (!empty($result->nicuDischargeWeight) && $result->nicuDischargeWeight != 0) ?  $result->nicuDischargeWeight : 'N/A' !!}</span>
                            </div>
                            <div class="form-group">
                                <span class="print-label">Discharge OFC (cm):</span>
                                <span class="print-value">{!! (!empty($result->nicu_ofc) && $result->nicu_ofc != 0) ?  $result->nicu_ofc : 'N/A' !!}</span>
                            </div>
                            <div class="form-group">
                                <span class="print-label">Discharge length (cm):</span>
                                <span class="print-value">{!! (!empty($result->nicu_Length) && $result->nicu_Length != 0) ?  $result->nicu_Length : 'N/A' !!}</span>
                            </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif
                <div class="problems-report-editor editor-align">
                    @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['Problems']))
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                <div class="summary-report-editor editor-align">
                    @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['summary']))
                    <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif  
                <div class="procedures-report-editor editor-align">
                    @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['Procedures']))
                    <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                <div class="summarybirth-report-editor editor-align">
                    @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['Summarybirth']))
                    <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif
        <div class="birth-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['Birth']))
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif
        <div class="respiratorysystem-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['RespiratorySystem']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif
        <div class="cardiovascularsystem-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['CardiovascularSystem']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="gastrointestinalsystem-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['GastrointestinalSystem']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="centralnervoussystem-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['CentralNervousSystem']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="sepsis-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['Sepsis']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="ophthalmology-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['Ophthalmology']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="hematology-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['Hematology']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="newbornscreening-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['NewbornScreening']))
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="communicationwithparents-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['Communicationwithparents']))
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="investigations-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['Investigations']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif 
        <div class="addedinfo-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['additional_information']))  
            <div class="editor-align-checkbox-div">
                {!! Form::checkbox('problem-status', '',true, ['class'=>'hidden-print','title'=>'Remove from the print', 'id'=>'addedinfo-modified']) !!}
                <label for="additional_information"><span class="hidden-print"></span></label>
            </div>
            <div class="editor-align-content">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif   
        <div class="dischargemedications-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['DischargeMedications']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        <div class="vaccine-report-editor editor-align">
            @if(count($dischargeSummarymodified) > 0 && !empty($dischargeSummarymodified['vaccine']))
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        <div class="dischargeinstructions-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['DischargeInstructions']))  
            <div class="editor-align-checkbox-div">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
        ...
        @endif  
        <div class="followup-report-editor editor-align">
            @if(count($dischargeSummarymodified) >  0 && !empty($dischargeSummarymodified['Followup']))  
            <div class="editor-align-checkbox-div">
...
<div class="col-md-12 discharge-info page-break-page">
    ...
    <div class="col-xs-8 col-md-8 col-sm-8 page-break-page" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="row" style="margin-left: 0px !important; margin-right: 0px !!important;">
            ...
            <div class="col-xs-6 col-md-6 col-sm-6 mb-15">
