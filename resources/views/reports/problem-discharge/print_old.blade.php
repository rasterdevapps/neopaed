...
<div class="temp-container nicu-summary">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 plr-must-0">
        <div class="col-xs-6 col-sm-6 col-md-6">
            <!-- Consultant Name :  -->
            <!-- <div>{{ SiteHelpers::get_doctors_name($neonatalDetails->neonatal_consultant) }}</div> -->
        </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 problem-summary-content">
        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page neonatal-basic-details">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0">
                <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-print">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">                    
                        <div class="form-group">
                            <span class="print-label">IP No.:</span>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
            ...
            @endif
            <div class="editor">
                <div id="new-problem-report-editor-p31" class="editor-align">
                    @if (isset($newproblem['p31'][0]) && !empty($newproblem['p31'][0]))
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
            ...
            @endif
            <div class="editor">
                <div id="new-problem-report-editor-p32" class="editor-align">
                    @if (isset($newproblem['p32'][0]) && !empty($newproblem['p32'][0]))
                    <div class="editor-align-checkbox-div">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
            ...
            <div class="parent-generated-content-container">
                ...
                <div class="parent-generated-content">
                    ...
                    <div id="report-editor-{{$episodeDetails->episode_id}}" class="editor-align">
                        @if (isset($newproblem[$problemname][$episode]) && !empty($newproblem[$problemname][$episode]))
                        <div class="editor-align-checkbox-div">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
            <h6>
                ...
                @endif
                <div class="editor">
                    <div id="new-problem-report-editor-p1" class="editor-align">
                        @if (isset($newproblem['p1'][0]) && !empty($newproblem['p1'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif
                <div class="editor">
                    <div id="new-problem-report-editor-p3" class="editor-align">
                        @if (isset($newproblem['p3'][0]) && !empty($newproblem['p3'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                <div class="editor">
                    <div id="new-problem-report-editor-p4" class="editor-align">
                        @if (isset($newproblem['p4'][0]) && !empty($newproblem['p4'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page neonatal-basic-details">
                ...
                <div class="editor">
                    <div id="new-problem-report-editor-p5" class="editor-align">
                        @if (isset($newproblem['p5'][0]) && !empty($newproblem['p5'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                <div class="editor">
                    <div id="new-problem-report-editor-p6" class="editor-align">
                        @if (isset($newproblem['p6'][0]) && !empty($newproblem['p6'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif 
                <div class="editor">
                    <div id="new-problem-report-editor-p7" class="editor-align">
                        @if (isset($newproblem['p7'][0]) && !empty($newproblem['p7'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif 
                <div class="editor">
                    <div id="new-problem-report-editor-p8" class="editor-align">
                        @if (isset($newproblem['p8'][0]) && !empty($newproblem['p8'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif                
                <div class="editor">
                    <div id="new-problem-report-editor-p9" class="editor-align">
                        @if (isset($newproblem['p9'][0]) && !empty($newproblem['p9'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 plr-must-0-screen page-break-page">
                ...
                @endif                
                <div class="editor">
                    <div id="new-problem-report-editor-p10" class="editor-align">
                        @if (isset($newproblem['p10'][0]) && !empty($newproblem['p10'][0]))
                        <div class="editor-align-checkbox-div">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 mt-30 mb-30 plr-must-0 summary-info page-break-page">
                <table class="table">
                    <tbody>
                        <tr>
                            <td class="pull-left">
                            ...
                            <td class="pull-right">
                                <table>
                                    <tbody>
                                        @php $consultant = unserialize($neonatalDetails->neonatal_consultant); @endphp
                                        @if(is_array($consultant) && count($consultant) > 0)
                                        <tr>
                                            @foreach($consultant as $value) 
                                            @php $doctor = $doctor_master->where('id', $value)->first(); @endphp 
                                            @if(count($doctor) > 0)
                                            <td class="text-center"><b>Signature<br/>{!! $doctor->Name !!} </b>&nbsp&nbsp&nbsp</td>
                                            @endif 
                                            @endforeach 
                                        </tr>
                                        @endif  
