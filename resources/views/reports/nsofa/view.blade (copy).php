...
<div class="crumbs bread-crumbs-shadow">
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li class="current"><a href="{{ action('Reports\nsofaController@index') }}">nSOFA Report</a></li>       
	</ul>
</div>
<!-- /Breadcrumbs line -->
<!--=== Page Content ===-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // data += cellContent(fio2_data, 'Fio2', ventilator_hour_list);
                ...
                data += respiratoryScoreCell(spo2_data, fio2, ventilator_hour_list, ventilator_type);
                return data;
            }
            ...
            function respiratoryScoreCell(spo2_data, fio2_data, hour_list, ventilator_type) {
                var data = '<tr>';
                data += '<td>';
                data += '<b>SpO2 / Fio2 (%)</b>';
                data += '</td>';
