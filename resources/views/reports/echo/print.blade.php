...
<div class="temp-container">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
          <h3 class="print-head">Echocardiography List</h3>
    </div>
  <div class="temp-row col-md-12 col-sm-12 col-xs-12 echo-report overflow-auto mt-15">   
      <table class="table table-striped">
        <thead>
                <tr>
                  ...
                  <th class="custom-date">Date of echo</th>                                
                  <th>Outcome</th>                                                                
