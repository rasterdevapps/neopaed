                        ...
                        <div class="col-md-12">
                            <div class="row mb-15">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('baby', ['N/A' => '-- Select --'] + $babies, $baby_id, ['class' => 'full-width', 'id' => 'ssearch', 'required']) !!}
                                ...
                                <div class="col-md-3" id="admission-container" style="display: none;">
                                    ...
                                    {!! Form::select('Admission_id', ['0' => '-- Select Admission --'], null, ['class' => 'full-width', 'id' => 'Admission_id']) !!}
