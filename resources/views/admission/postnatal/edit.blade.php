...
<!-- Breadcrumbs line -->
@php
if(isset($_COOKIE['postnatal-form'])) {
$_COOKIE['postnatal-form'] = 'basicform';
}  
$site_url = url('/').'/public';
@endphp
...
<div class="crumbs bread-crumbs-shadow">
    <ul id="breadcrumbs" class="breadcrumb">
       ...
       <li>
           <a title="" href="{{ action('Admission\PostnatalController@postnatalAdmissionlist',SiteHelpers::encrypt_id($postnatal->BabyId))}}">Admission List</a>
       </li>
       <li class="current">
        <a title="">Edit</a>
    </li>
...
<div class="row row-spacing" id="postnatal-admission-form">
    <div class="col-md-12">
        {!! Form::model($postnatal,['url' => action('Admission\PostnatalController@update', $postnatal->pid),'method'=>'patch','id' => 'admissionProforma-form', 'class'=>'post-admission-form']) !!}
        {!! Form::hidden('MotherId') !!}
        {!! Form::hidden('BabyId') !!}
        {!! Form::hidden('AdmissionId',$postnatal->admissionid) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input clear-xs">
                                        <div class="row col-md-12 display-flex">
                                            <div>
                                                <small>(In Weeks)</small>
                                                {!! Form::text('cg_weeks',null,['class'=>'form-control corrected-gestation-wks']) !!}
                                            ...
                                            <div>
                                                <small>(In Days)</small>
                                                {!! Form::text('cg_days',null,['class'=>'form-control corrected-gestation-days']) !!}
                        ...
                        <div class="mt-10 widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        @php
                                        $readonly = ($postnatal->ip_number == '' && $postnatal->hospital_name == 'SKS Hospital') ? '' : 'readonly';
                                        @endphp
                                        {!! Form::text('ip_number',null,['class'=>'form-control ip_number', $readonly])  !!}
                                        @if (@$postnatal->ip_number == '')
                        ...
                        <div class="mt-10 widget box">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('nicu_color',['Pale'=>'Pale','Pink' => "Pink","Acral Cyanosis"=>"Acral Cyanosis","Central Cyanosis"=>"Central Cyanosis"], null,['class'=>' form-control','data-color'=>ValuelistHelpers::setColorvalue('Color')]) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <table class="IVAntibiotic table table-add-more full-width-fix">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="fa fa-trash btn btn-danger btn-view remove-ivantibitic"></span>
                                                            </td>
                                                        </tr>
                                                        @endforeach   
                                                        @else
                                    ...
                                    <div class="col-md-12 col-sm-12">    
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 custom-input">
                                                <table>
                                                    <tr>
                                                        <td> {!! Form::select('pdiscussion_hrs',$timeList['time'],null,['class'=>'form-control']) !!} </td>
                                                        <td class="form-group-spacing"> {!! Form::select('pdiscussion_min',$timeList['mins'],null,['class'=>'form-control']) !!} </td>
                                                        <td> {!! Form::select('pdiscussion_session',$timeList['session'],null,['class'=>'form-control']) !!} </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-11 col-sm-12">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <button  type="button" class="btn btn-primary save-button-shadow btn-block form-control postnatal_create_btn" data-flag="1">
                                    <i class="fa fa-floppy-o"></i> 
                                    <span>{!! $SubmitButtonText !!}</span>
                                </button>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <button type="button" class="btn btn-block save-button-shadow btn-info form-control postnatal_create_btn" data-flag="2"> 
                                    <i class="fa fa-floppy-o"></i>
                                    <span>Update</span>
                                </button>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <button type="button" class="btn btn-block save-button-shadow btn-info form-control postnatal_create_btn" data-flag="3">
                            ...
                            <!-- <div class="col-md-3 col-sm-6">
                                <button type="button" class="btn btn-primary save-next save-button-shadow btn-block form-control next @if(\Session::has('multiple_pregnancy') && isset($_COOKIE['postnatal-next']) && $_COOKIE['postnatal-next'] == 'Diagform') next-baby @endif"><i class="fa fa-floppy-o"></i> 
                                    <span>@if(!\Session::has('multiple_pregnancy') && isset($_COOKIE['postnatal-next']) && $_COOKIE['postnatal-next'] == 'Diagform') Finish @elseif(\Session::has('multiple_pregnancy') && isset($_COOKIE['postnatal-next']) && $_COOKIE['postnatal-next'] == 'Diagform') Next baby @else Next @endif</span>
                                </button>
                            </div>  -->
                            <div class="col-md-3 col-sm-6">
                                <button  type="button" class="btn btn-primary save-button-shadow btn-block form-control" onclick="@if(\Session::has('multiple_pregnancy')) multiplePreganancyadmission(); @else  $('#print_flag').val('1'); $(form).submit(); @endif">
                                    <i class="fa fa-floppy-o"></i> 
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
             ...
             @if($postnatal->uac_status == true)
             $('#uac_status').bootstrapToggle('on');
             @endif
             @if($postnatal->uvc_status == true)
             $('#uvc_status').bootstrapToggle('on');
             @endif

             @if($postnatal->ventilation == true)
             $('#ventilation').bootstrapToggle('on');
             @endif
             @if($postnatal->ventilation == true)
             $('#ventilation').bootstrapToggle('on');
             @endif
            ...
            $('.nav-tabs li a').click(function(){
              ...
              $.cookie('postnatal-next', $(this).attr('aria-controls'));

              if ($(this).attr('aria-controls') == 'Diagform') {
          ...
          function saveNext() {
            ...
            if ($.cookie('postnatal-next') == 'Diagform') {

             $('#print_flag').val('1'); 

         } else if($('.save-next').hasClass('next-baby')) {
...
// var acive_id = $.cookie('postnatal-next');
// if(acive_id!='' && acive_id!=null ) {
...
$(document).on('click', '.postnatal_create_btn', function(e){
    if ($('#admissionProforma-form').valid() === true) {
        ...
        $.ajax({
            ...
            url: "{{ action('Admission\PostnatalController@update', $postnatal->pid) }}",
            success: function (response) {
                if (print_flag == 2) {
                    $('.postnatal_create_btn').prop('disabled', false);
