...
<!-- /Breadcrumbs line -->
{!! Form::model($baby,['url' => action('ProblemBaseDaycare\ProblemDaycareController@store'),'id'=> 'problem_base_daycare']) !!}
<div class="row problem-based-container container-fluid">
    ...
    <div class="col-md-12 col-xs-12">
        ...
        <a style ="margin-right: 10px;"href="{{ url('problem-systems-episodes/'.$id) }}" class="btn btn-primary btn-basic-shadow pull-right">
    ...
    <div class="col-md-12 main-title full-width widget box col-xs-12">
        ...
        <div class="col-md-12 widget-content mb-15 col-xs-12">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 col-sm-6">
                    <a class="btn btn-info btn-shadow-special form-control btn-block" href="{{ action('ProblemBaseDaycare\ProblemDaycareController@episodeslist',$id) }}">
...
<script type="text/javascript">
    ...
    // if ($('#problem_base_daycare').valid() === true) {
        ...
        $.ajax({
            ...
            url: "{{ action('ProblemBaseDaycare\ProblemDaycareController@store') }}",
