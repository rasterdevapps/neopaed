...
<div class="row row-spacing select-container-main">
	<div class="master-btn-layout">
		{!! Form::model($results,['method'=> 'PATCH','url' => action('Masters\PrescriptionTypeController@update',$results->pres_id),'id'=>'EditForm']) !!}
		<div class="row select-option-container">
			...
			<div class="col-md-12 select-container-main">
				...
				<a href="{{ action('Masters\PrescriptionTypeController@index') }}" class="btn btn-default btn-basic-shadow form-control  input-width-medium" onclick="$('form')[0].reset();">
