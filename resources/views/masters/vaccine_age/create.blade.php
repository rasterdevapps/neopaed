...
<div class="row row-spacing select-container-main">
    <div class="master-layout">
        {!! Form::open(['url' => action('Masters\VaccineAgeController@store'),'id'=> 'checkform']) !!}
        <div class="col-md-12 overflow-auto">
            <table class="master_vaccine_age table table-add-more full-width-fix">
                <thead>
                    <tr>
                        <th>Age</th>
                        <th>Status</th>
                        <th>
                            <span>
                            <a class="btn btn-success add-values btn-view vaccine_age_add" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
                            </span>                
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr data-len="0">
                        <td><input type="text" name="age[]" data-nameLen="1" value="" class="form-control input-fields-shadow input-width-medium valid" /></td>
                        <td>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="master-btn-layout">
                                ...
                                <a href="{{ action('Masters\VaccineAgeController@index') }}" class="btn btn-default btn-basic-shadow form-control input-width-medium" onclick="$('form')[0].reset();">
