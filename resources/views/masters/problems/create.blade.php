...
<div class="crumbs bread-crumbs-shadow">
 ...
 <li>
   <a href="{{ action('Masters\ProblemController@index') }}">Problems</a>
 </li>       
 <li class="current">
   <a>Create</a>
 </li>                                                 
...
<!--					<div class="page-title">
          ...
          <div class="row row-spacing select-container-main">
           <div class="master-layout">
             {!! Form::open(['url' => action('Masters\ProblemController@store'),'id'=> 'checkform']) !!}
                  ...
                  <tr>
                    <td colspan="4">
                      <div class="master-btn-layout">
                        ...
                        <a href="{{ action('Masters\ProblemController@index') }}" class="btn btn-default form-control btn-basic-shadow input-width-medium" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                      </div>
                    </td>
                  </tr>
                </tfoot>
