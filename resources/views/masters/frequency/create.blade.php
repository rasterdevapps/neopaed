...
<div class="row row-spacing select-container-main">
  <div class="master-layout">
    {!! Form::open(['url' => action('Masters\FrequencyController@store'),'id'=> 'checkform']) !!}
    {!! Form::hidden('Id',null,['class'=>'form-control','id'=>'Id']) !!}
    <div class="col-md-12 overflow-auto">
      <table class="master_frequency multi-row table table-add-more full-width-fix">
        <thead>
          <tr>
            <th>Name</th>
            <th>Value</th>
            ...
            <th>
              <span>
                <a class="btn btn-success master_frequency_add btn-view btn_add" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
              </span>                
            </th>                                            
          </tr>
        </thead>
        ...
        <tr>
          <td colspan="5">
            <div class="master-btn-layout">
              ...
              <a href="{{ action('Masters\FrequencyController@index') }}" class="btn btn-basic-shadow btn-default form-control input-width-medium" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> Cancel</a>
            </div>
          </td>
        </tr>
      </tfoot>
