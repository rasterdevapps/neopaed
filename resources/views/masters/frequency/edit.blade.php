...
<div class="row row-spacing select-container-main">
	<div class="master-btn-layout">
		{!! Form::model($results,['method'=> 'PATCH','url' => action('Masters\FrequencyController@update',$results->freq_id),'id'=>'EditForm']) !!}
		...
		<div class="col-md-12 select-container-main">
				...
				<a href="{{ action('Masters\FrequencyController@index') }}" class="btn btn-default btn-basic-shadow form-control input-width-medium" onclick="$('form')[0].reset();">
