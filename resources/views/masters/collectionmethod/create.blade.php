...
<div class="crumbs bread-crumbs-shadow">
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li><a href="{{ action('Masters\CollectioMethodController@index') }}">Collection Method</a></li>       
...
<div class="row row-spacing">
    ...
    {!! Form::open(['url' => action('Masters\CollectioMethodController@store'),'id'=> 'checkform']) !!}
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-4">
                  <a href="{{ action('Masters\CollectioMethodController@index') }}" class="btn btn-default form-control btn-basic-shadow btn-block" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> <span>Cancel</span></a>
          </div>
        </div>
      </div>
      {!! Form::close() !!}
