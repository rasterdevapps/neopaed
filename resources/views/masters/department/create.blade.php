...
@section('content')
	...
	<div class="row row-spacing">
		<div class="col-md-9">
			{{ Form::open(['url' => action('Masters\DepartmentController@store')]) }}
				<div class="col-md-12 form-group">
					<table class="master_department multi-row col-md-12">
						<thead>
							<tr>
								<th>Name</th>
								<th>Status</th>
					...
					<a class="btn save-button-shadow btn_add master_department_add"><i class="fa fa-plus"></i><span>Add More</span></a>
					<div class="row">
						<div class="col-md-3">
