...
<div class="row row-spacing select-container-main">
	<div class="master-layout">
		{!! Form::model($results,['method'=> 'PATCH','url' => action('Masters\CBCLQuestionsController@update', 0),'id'=>'EditForm']) !!}
			...
			<table class="master_investigations multi-row table table-add-more full-width-fix">
				...
				<tbody>
					<tr>
						...
						<td>
                            {!! Form::select('category',ValuelistHelpers::cbclQuestionTypes(),null,['class'=>'form-control']) !!}
						</td>
                        <td class="text-center">
								@php $checked = ($results->describe == 1) ? 'checked' : ''; @endphp
                            <input data-size="small" name="describe" data-off="No" data-on="Yes" data-width="100" data-toggle="toggle" class="form-control switch-input" type="checkbox" {{$checked}} />
                        </td>
						<td>
