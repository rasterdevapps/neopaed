...
<div class="crumbs bread-crumbs-shadow">
  <ul id="breadcrumbs" class="breadcrumb">
    ...
    <li>
      <a href="{{ action('Masters\MediprobsController@index') }}">Medical Problems</a>
    </li>       
    <li class="current">
      <a>Create</a>
    </li>                                                 
...
<!--          <div class="page-title">
          ...
          <div class="row row-spacing select-container-main">
            <div class="master-layout">
             {!! Form::open(['url' => action('Masters\MediprobsController@store'),'id'=> 'checkform']) !!}
                  ...
                  <tr>
                    <td colspan="4">
                      <div class="master-btn-layout">
                        <button type="submit" class="btn btn-primary form-control btn-basic-shadow btn-block"><i class="fa fa-floppy-o"></i> Save</button>
                        <a href="{{ action('Masters\MediprobsController@index') }}" class="btn btn-default form-control btn-basic-shadow btn-block" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                      </div>
                    </td>
                  </tr>
                </tfoot>
