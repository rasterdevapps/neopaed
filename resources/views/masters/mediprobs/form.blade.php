       ...
       <div class="col-md-12 select-container-main">
        ...
        <a href="{{ action('Masters\MediprobsController@index') }}" class="btn btn-default form-control btn-basic-shadow input-width-medium" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> <span>Cancel</span></a>
      </div>
    </div>
