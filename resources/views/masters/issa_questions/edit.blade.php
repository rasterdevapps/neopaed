...
<div class="row row-spacing select-container-main">
	<div class="master-layout">
		{!! Form::model($results,['method'=> 'PATCH','url' => action('Masters\ISSAQuestionsController@update', 0),'id'=>'EditForm']) !!}
			...
			<table class="master_investigations multi-row table table-add-more full-width-fix">
				...
				<tbody>
					<tr>
						...
						<td>
                            {!! Form::select('category',ValuelistHelpers::issaQuestionTypes(),null,['class'=>'form-control']) !!}
						</td>
						<td>
