...
<!--					<div class="page-title">
				...
				<div class="row row-spacing select-container-main">
					<div class="master-btn-layout">
							{!! Form::model($results,['method'=> 'PATCH','url' => action('Masters\ProcedureController@update',$results->Id),'id'=>'EditForm']) !!}
                       		    @include('masters.procedures.form',['SubmitButtonText'=>'Update'])
                       {!! Form::close() !!}
                      @include('errors.list')
					</div> <!-- /.col-md-12 -->
