...
<div class="crumbs bread-crumbs-shadow">
	<ul id="breadcrumbs" class="breadcrumb">
		...
		<li><a href="javascript:void(0);">Clinical Event</a></li>
	...
	<div class="col-md-6 col-sm-6 col-xs-6">
        <div class="row select-option-container">
            ...
            <div class="col-md-12 mt-15">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <a href="{{ action('ClinicalEventController@create') }}" class="cancel-btn save-button-shadow btn btn-default form-control btn-block" onclick="$('form')[0].reset();"><i class="fa fa-exclamation-circle"></i> <span>Cancel</span></a>
                </div>
            </div>                           
        </div>
	</div> <!-- /.col-md-12 -->
...
$(".submittbtn").click(function() {
    ...
    if (babyId != 0 && admissionId != 0) {
        ...
        $.ajax({
            type: 'GET',
            url: "{{ action('ClinicalEventController@select') }}",
            data: {
                baby_id: babyId,
