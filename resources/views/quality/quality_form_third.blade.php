<div class="col-md-12 plr-0">
    ...
    <div class="col-md-12 display-sm-inline-block full-width border-bottom mb-10">
        ...
        <div class="col-md-6 col-sm-12 plr-0">
            ...
            <div class="col-md-7 col-sm-7 display-flex pr-0 plr-xs-0 pr-sm-15">
    ...
    <div class="col-md-10 display-inline-block full-width">
        @php $central_line_type = (isset($baby_basic->central_line_type) && !is_null($baby_basic->central_line_type)) ? json_decode($baby_basic->central_line_type) : array(); @endphp
    ...
    <div class="col-md-12 display-inline-block full-width plr-0">
        <div class="col-md-6 col-sm-12 pl-0">
            ...
            <div class="col-md-7 col-sm-7 display-flex pr-xs-0">
                <div class="col-md-8 col-sm-8 col-xs-8 pl-sm-25 pr-xs-5 pl-md-30 pr-must-0 pr-sm-15">
                    {!! Form::select('outcome_result',['Death'=>'Death','Discharge'=>'Discharge','LAMA'=>'LAMA'],null,['class'=>'form-control shadow']) !!}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12 display-inline-block full-width border-bottom mb-10">
        ...
        <div class="col-md-6 col-sm-12 plr-0">
            <div class="col-md-offset-0 col-md-5 col-sm-offset-5 col-sm-7 plr-0 plr-sm-15 plr-xs-0 display-flex">
    ...
    <div class="col-md-12 plr-30">
        ...
        @php $case_death = (isset($baby_basic->case_death) && !is_null($baby_basic->case_death)) ? json_decode($baby_basic->case_death) : array(); @endphp
    ...
    <div class="col-md-12 border-bottom plr-30">
