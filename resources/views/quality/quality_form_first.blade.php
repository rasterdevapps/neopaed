    ...
    <div class="col-md-12 border-bottom mb-10 plr-0">
        <div class="col-md-6 border-right">
            ...
            <div class="col-md-12 display-sm-inline-block full-width border-bottom mb-10 plr-0">
              <div class="col-md-3 col-sm-3">
               {!! Form::label('mr_number', Lang::get('home.mrn'),['class'=>'title required-label']) !!}
              </div>
            ...
            <div class="col-md-12 display-sm-inline-block full-width border-bottom mb-10 plr-0">
                <div class="col-md-6 col-sm-6 plr-0">
                    <div class="col-md-6 col-sm-6">{!! Form::label('dob','DOB',['class'=>'title']) !!}</div>
                    <div class="col-md-5 col-sm-5">{!! Form::text('dob',null,['class'=>'form-control shadow','id'=>'dob','placeholder'=>'dd-mm-yyyy', 'readonly']) !!}</div>
                </div>
                <div class="col-md-6 col-sm-6 plr-0">
                    <div class="col-md-5 col-sm-5">{!! Form::label('tob','TOB',['class'=>'title']) !!}</div>
                ...
                <div class="col-md-9 col-sm-9 display-flex plr-0">
                    <div class="col-md-5 col-sm-5 col-xs-8 pr-5">
                        <table>
                            <tbody>
                                <tr>
                                    <td class="col-md-5 col-sm-5 col-xs-5 pl-0 pr-5 overflow-auto">{!! Form::text('gestation_weeks', null,['class'=>'form-control shadow']) !!}</td>
                                    <td class="col-md-2 col-sm-2 col-xs-2 plus text-center overflow-auto">+</td>
                                    <td class="col-md-5 col-sm-5 col-xs-5 pl-5 pr-5 overflow-auto">{!! Form::text('gestation_days', null,['class'=>'form-control shadow']) !!}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="col-md-12 display-inline-block full-width border-bottom mb-10 plr-0">
                ...
                <div class="col-md-5 col-sm-5 pr-10">{!! Form::select('mode_of_delivery', ['NVD'=>'NVD', 'VD(Assisted)'=>'VD (Assisted)','LSCS(Elective)'=>'LSCS(Elective)','LSCS(Emergency)'=>'LSCS(Emergency)','Ventouse'=>'Ventouse','Caesarian'=>'Caesarian'],null,['class'=>'form-control shadow']) !!}</div>
            </div>
            <div class="col-md-12 display-inline-block full-width border-bottom mb-10 plr-0">
            ...
            <div class="col-md-12 display-inline-block border-bottom mb-10 plr-0">
                ...
                <div class="col-md-offset-3 col-md-9 col-sm-offset-3 col-sm-9 col-xs-12">{!! Form::radio('fetalcause','6') !!}{!! Form::label('other','Other',['class'=>'title']) !!}</div>
            </div>
            <div class="col-md-12 display-inline-block full-width border-bottom mb-10 plr-0">
            ...
            <div class="col-md-12 display-inline-block plr-0">
                @php $sepsis_in_mother_type = (isset($baby_basic->sepsis_in_mother_type) && !is_null($baby_basic->sepsis_in_mother_type)) ? json_decode($baby_basic->sepsis_in_mother_type) : array(); @endphp
                @php $sepsis_in_mother_type1 = (!is_null($sepsis_in_mother_type) && in_array('1',$sepsis_in_mother_type)) ? true : false; @endphp
                @php $sepsis_in_mother_type2 = (!is_null($sepsis_in_mother_type) && in_array('2',$sepsis_in_mother_type)) ? true : false; @endphp
                @php $sepsis_in_mother_type3 = (!is_null($sepsis_in_mother_type) && in_array('3',$sepsis_in_mother_type)) ? true : false; @endphp
                @php $sepsis_in_mother_type4 = (!is_null($sepsis_in_mother_type) && in_array('4',$sepsis_in_mother_type)) ? true : false; @endphp
                @php $sepsis_in_mother_type5 = (!is_null($sepsis_in_mother_type) && in_array('5',$sepsis_in_mother_type)) ? true : false; @endphp
                @php $sepsis_in_mother_type6 = (!is_null($sepsis_in_mother_type) && in_array('6',$sepsis_in_mother_type)) ? true : false; @endphp
        ...
        <div class="col-md-6 display-inline-block">
            ...
            <div class="col-md-12 col-sm-12 plr-0">
                ...
                <div class="col-md-4 col-sm-4 pr-0 plr-xs-0">
                    <div class="col-md-12 col-sm-12 pr-0 pr-xs-15">
                        {!! Form::select('medication_details',['adr'=>'adr','NS'=>'NS','Naloxone'=>'Naloxone','Inotropes'=>'Inotropes','Dextrose Bolus' => 'Dextrose Bolus','Bicarbonate'=> 'Bicarbonate'],null,['class'=>'form-control shadow']) !!}
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-sm-12 plr-0">
            ...
            <div class="col-md-12 col-sm-12 title border-bottom mb-10 plr-0">
                <div class="col-md-12 col-sm-12 display-flex full-width border-bottom mb-10 pr-0">
            ...
            <div class="col-md-12 col-sm-12 plr-0">
                ...
                <div class="col-md-7 col-sm-7 pl-30 pl-xs-15">
                    @php $indication = (isset($baby_basic->indication_of_admission) && !is_null($baby_basic->indication_of_admission)) ? json_decode($baby_basic->indication_of_admission) : array() @endphp
            ...
            <div class="col-md-12 col-sm-12">{!! Form::label('surfactant_type','TYPE',['class'=>'title']) !!}
                  @php $sepsis_in_mother_type = (isset($baby_basic->surfactant_type) && !is_null($baby_basic->surfactant_type)) ? json_decode($baby_basic->surfactant_type) : array() @endphp
