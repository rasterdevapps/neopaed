<div class="col-md-12 plr-0">
    <div class="col-md-12 display-inline-block full-width plr-0">
        ...
        <div class="col-md-3 col-sm-3 pl-0 pl-xs-15">{!! Form::select('res_support_type',['O2 prongs, hood'=>'O2 prongs, hood','HHHFNC'=>'HHHFNC','CPAP'=>'CPAP','NIPPV'=>'NIPPV','Nasal HFOV'=>'Nasal HFOV','MV (Conventional)'=>'MV (Conventional)','MV(HFOV)'=>'MV(HFOV)'],null,['class'=>'form-control shadow']) !!}</div>
    </div>
    ...
    <div class="col-md-12 col-sm-12 border-bottom mb-10">
        ...
        <div class="col-md-6 col-sm-12 plr-0">
            ...
            <div class="col-md-7 col-sm-6 display-flex plr-0">
                <div class="col-md-4 col-sm-4 col-xs-4 pl-8">{!! Form::radio('developedshock','N/A') !!}{!! Form::label('N/A','N/A',['class'=>'title']) !!}</div>
                <div class="col-md-4 col-sm-4 col-xs-4 pl-10">{!! Form::radio('developedshock','Yes') !!}{!! Form::label('yes','Yes',['class'=>'title']) !!}</div>
    ...
    <div class="col-md-12 scroll-x">
        ...
        <table class="table responsive-table">
            ...
            <tbody class="tableborder">
                @for ($i=1; $i<=3; $i++) 
                <tr>
                    <td> @switch($i) @case(1) 1 <sup>st</sup> @break @case(2) 2 <sup>nd</sup> @break @case(3) 3 <sup>rd</sup> @break @default New @endswitch CULTURE </td>
                    <td>
