...
<div class="crumbs bread-crumbs-shadow">
    <ul id="breadcrumbs" class="breadcrumb">
        ...
        <li><a href="{{ action('Extras\UltraController@index') }}">Carnial Ultrasonography</a></li>
...
<div class="row row-spacing mlr-0">
    <div class="col-md-12 col-sm-12 tab-view-shadow plr-0 ptb-15">
        @include('errors.list') 
        {!! Form::model($baby,['url' => action('Extras\UltraController@store'), 'id'=>'ultrasonography-form']) !!}                                                
        ...
        <div class="row col-md-11 col-sm-12">
            <div class="col-md-3 col-sm-4 col-xs-12">
                <button type="submit" class="btn btn-primary save-button-shadow btn-block form-control ultra-save-btn"><i class="fa fa-floppy-o"></i> <span>{!! $SubmitButtonText !!}</span></button>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
                <input type="hidden" name="print_flag" value="0" id="print_flag" />
                <button type="button" class="btn btn-block save-button-shadow btn-info form-control ultra-save-btn"  data-flag="1"><i class="fa fa-print"></i> <span>Print</span></button>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
...
$(document).on('click', '.ultra-save-btn', function(e){
    if ($('#ultrasonography-form').valid() === true) {
        ...
        $.ajax({
            ...
            url: "{{ action('Extras\UltraController@store') }}",
            success: function (response) {
                if (print_flag == 1) {
                    Showalert('success', 'Ultrasonography Details Stored Successfully');
