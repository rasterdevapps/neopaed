...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function generateSheets(prescription, fromdate = '', todate = '') {
            ...
            var sheet_length = [];
            sheet_length.push(Math.ceil(regular_list.length / 12));
            sheet_length.push(Math.ceil(stat_list.length / 15));
            sheet_length.push(Math.ceil(required_list.length / 6));
            sheet_length.push(Math.ceil(intravenous_list.length / 18));
            ...
            for (var sheet_i = 1; sheet_i <= sheet_count; sheet_i++) {
                if (sheet_i == 1) {
                    regular_sheet_1 = sheet_i * 6;
                    stat_sheet_1 = sheet_i * 7;
                    regular_sheet_2 = sheet_i * 12;
                    stat_sheet_2 = sheet_i * 15;
                    required_sheet_1 = sheet_i * 6;
                    intravenous_sheet_1 = sheet_i * 18;
                    ...
                    regular_start1 = 12 * (sheet_i - 1);
                    stat_start1 = 15 * (sheet_i - 1);
                    required_start1 = 6 * (sheet_i - 1);
                    intravenous_start1 = 18 * (sheet_i - 1);
                    regular_sheet_1 = regular_start1 + 6;
                    regular_start2 = regular_sheet_1;
                    stat_sheet_1 = stat_start1 + 7;
                    stat_start2 = stat_sheet_1;
                    regular_sheet_2 = regular_start2 + 6;
                    stat_sheet_2 = stat_start2 + 8;
                    required_sheet_1 = required_start1 + 6;
                    intravenous_sheet_1 = intravenous_start1 + 18;
