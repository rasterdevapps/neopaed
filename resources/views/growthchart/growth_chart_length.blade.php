...
@php $girls_chart_length  = url('public/img/growth-chart/growth_preterm_girls_lt_en.svg'); @endphp
...
function growthLengthChart(chartId,sex,chartCharacter){
		...
		//xAxis contain weight
         ...
         var xAxisLength = new AmCharts.ValueAxis();
		    ...
		    xAxisLength.gridCount = 44;
		    xAxisLength.gridAlpha = 0;
		    xAxisLength.maximum  = 72;
		    xAxisLength.minimum  = (sex == 'Female') ? 26 : 28;
		...
		babyGrowthlineLength.bullet = "round";
...
$(document).ready(function() {
  ...
  growthLengthChart('{{ $growth_chart_id }}','{{ $sex }}','{{ $chartType }}');
...
window.onbeforeprint = growthLengthChart('{{ $growth_chart_id }}','{{ $sex }}','{{ $chartType }}');
</script>
