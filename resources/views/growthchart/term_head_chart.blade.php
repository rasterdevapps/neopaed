@php $boys_chart_head  = url('public/img/growth-chart/chart_head_boy.svg'); @endphp
@php $girls_chart_head  = url('public/img/growth-chart/chart_head_girls.svg'); @endphp
...
<script type = "text/javascript">
    $(document).ready(function() {
        function getHeaddata(sex, chartCharacter) {
            if (sex == 'Male') {
                return JSON.parse('{!! $term_boys_head !!}');
            } else if (sex == 'Female') {
                return JSON.parse('{!! $term_girls_head !!}');
            }
        }
        ...
        function setHeadChartBackground(sourceId, sex, chartCharacter) {
            ...
            if (sex == 'Male') {
                ...
                $('#' + sourceId).css('background-image', 'url("{{ $girls_chart_head }}")').css('background-color', '#4D90FE');
            }
        }
        ...
        function growthChart(chartId, sex, chartCharacter) {
            ...
            xAxisHead.maximum = (sex == 'Female') ? 51 : 52;
            xAxisHead.minimum = (sex == 'Female') ? 30.5 : 31.4;
            ...
            yAxisHead.gridCount = 24;
            yAxisHead.gridAlpha = 0;
            yAxisHead.maximum = 24;
            yAxisHead.minimum = 0;
