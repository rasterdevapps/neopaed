...
<div class="row row-spacing mlr-0 ">
    <div class="col-md-12 col-sm-12 col-xs-12 tab-view-shadow ptb-15 plr-0">
        @include('errors.list')
        {!! Form::model($results,['method' => 'PATCH','url' =>  action('Extras\CardioController@update',$results->EchoId),'id' => 'echocardiography']) !!}
        ...
        <div class="col-md-12 col-sm-12">
            <div class="mt-10 widget box">
                ...
                <div class="widget-content">
                    <div class="form-group row">
                        <div class="col-md-1 col-sm-12 text-right label-control">
        ...
        <div class="col-md-11 col-sm-12">
            <div class="col-md-3 col-sm-4 col-xs-12">
                <button type="submit" class="btn btn-primary save-button-shadow btn-block form-control echo-save-button"><i class="fa fa-floppy-o"></i> <span>{!! $SubmitButtonText !!}</span></button>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
...
$(document).on('click', '.echo-save-button', function(e){
    if ($('#echocardiography').valid() === true) {
        ...
        $.ajax({
            ...
            url: "{{ action('Extras\CardioController@update',$results->EchoId) }}",
            success: function (response) {
                if (print_flag == 1) {
                    Showalert('success', 'Echo details updated successfully');
