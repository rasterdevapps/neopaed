...
<div class="crumbs bread-crumbs-shadow">
    <ul id="breadcrumbs" class="breadcrumb">
        ...
        <li class="current"><a title="">Create {{ $baby->BabyName }}</a></li>
    </ul>
</div>
<div class="row row-spacing">
    <div class="col-md-12 nurse-sheet-daily-entry">
        {!! Form::model($baby,['url' => action('Nurse\NicuNurseDaycareController@store'),'id'=>'nurse-daycare']) !!}
        @include('errors.list')
            ...
            <div class="tab-content tab-view-shadow ">
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::text('DayOfLife',null,['class'=>'form-control', 'onkeypress'=>'return ISNumber(event, this);', 'readonly']) !!}
                                    </div>
                                </div>
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input clear-xs">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                {!! Form::select('DayTime',$times['time'],null,['class'=>'form-control input-width-small']) !!}
                                                <label for="DayTime" generated="true" class="error help-block"></label>
                                            </div>
                                            <div class="col-xs-4">
                                                {!! Form::select('DayTime_MINS',$times['mins'],null,['class'=>'form-control input-width-small']) !!}
                                                <label for="DayTime_MINS" generated="true" class="error help-block"></label>
                                            </div>
                                            <div class="col-xs-4">
                                                {!! Form::select('DayTime_AM',$times['session'],null,['class'=>'form-control input-width-small']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Care',[''=>'N/A','Intensive Care'=>'Intensive Care','Special Care'=>'Special Care','Ward Admission'=>'Ward Admission','High Dependancy Care'=>'High Dependancy Care'],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('care',5)]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('Frequency',ValuelistHelpers::frequencyList(),'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('feed_frequency',5)]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control md-mt-50">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('AspirateNature',[''=>'N/A','Nil' =>"Nil","Milky"=>"Milky","Yellow"=>"Yellow","Light green"=>"Light &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; green","Dark green"=>"Dark &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; green","Bloody"=>"Bloody","Altered brown"=>"Altered &nbsp; &nbsp; brown","Clear"=>"Clear"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('AspirateNature',5)]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('StoolNature',ValuelistHelpers::stoolNature(),null,['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('stool_nature',5)]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::number('workingWeight',null,['class'=>'form-control', 'id'=> 'workingWeight', 'onkeypress'=>'return ISNumber(event, this);']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::select('UrineOutput',[''=>'N/A','Passed' => "Passed","Not Passed"=>"Not Passed","Unmeasurable"=>"Unmeasurable"],'',['class'=>'form-control','data-color'=>ValuelistHelpers::setColorvalue('urine_output',5)]) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                                ...
                                {!! Form::hidden('PreviousProblems'); !!}
                                {!! Form::hidden('CurrentProblems'); !!}
                                {!! Form::hidden('TotalFluid',null,['id'=>'TotalFluid']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget box mt-10">
                            ...
                            <div class="widget-content">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::number('Feeds',null,['class'=>'form-control', 'id'=> 'Feeds', 'onkeypress'=>'return isNumber(event, this);']) !!}
                                    </div>
                                </div>    
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control" style="margin-top: 25px;">
                                    ...
                                    <div class="col-md-9 custom-input clear-xs">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-5">
                                                {!! Form::number('iv_fluids_ml_day',null,['class'=>'form-control' ,'readonly'=>true, 'id' => 'iv_fluids_ml_day']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input clear-xs">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-5">
                                                {!! Form::number('drug_infusions_ml_day',null,['class'=>'form-control','readonly'=>true, 'id'=> 'drug_infusions_ml_day', 'onkeypress'=>'return isNumber(event, this);']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 custom-input">
                                        {!! Form::number('Ivf',null,['class'=>'form-control','readonly'=>true, 'id'=> 'Ivf']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 text-right label-control">
                ...
                <div class="col-md-11 col-sm-12">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <button type="button" class="btn btn-block save-button-shadow btn-primary form-control daycare_save_btn" data-flag="1"><i class="fa fa-floppy-o"></i>
        ...
        $(document).on('click', '.daycare_save_btn', function(e){
            if ($('#nurse-daycare').valid() === true) {
                ...
                $.ajax({
                    ...
                    url: "{{ action('Nurse\NicuNurseDaycareController@store') }}",
